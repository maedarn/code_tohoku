...
double precision  :: subs_time_CPU(20)
END MODULE mpivar
...
,'CT',subs_time_CPU(9)-subs_time_CPU(8)
...
do i = 1, Ncell
  ...
  Blg(ix,jy,kz,2) = Bcc(ix,jy,kz,BT2)*dxelr(i) / ( xlag(ix,jy,kz) - xlag(ixm,jym,kzm) )
   ...
   ndHm(ix,jy,kz) = dxelr(i)* ndHm(ix,jy,kz)/( xlag(ix,jy,kz) - xlag(ixm,jym,kzm) )
  ...
  ndfgr(ix,jy,kz) = dxelr(i)*ndfgr(ix,jy,kz)/( xlag(ix,jy,kz) - xlag(ixm,jym,kzm) )
end do
...
do i = 0, Ncell
  ...
  !if(vadt.le.0.d0) then
    ...
    depend = 0.5d0 * (dxlag(i+1) + vadt) * facdep * dbleif +&
    0.5d0 * (dxlag(i  ) - vadt) * facdep * (1.d0-dbleif)
    F(i,1) = -vadt * ( U(ixp,jyp,kzp,1) - depend*grdU(i+1,1) )* dbleif &
    -vadt * ( U(ix ,jy ,kz ,1) + depend*grdU(i  ,1) )* (1.d0-dbleif)
    F(i,2) = -vadt * ( U(ixp,jyp,kzp,2) - depend*grdU(i+1,2) )* dbleif &
    -vadt * ( U(ix ,jy ,kz ,2) + depend*grdU(i  ,2) )* (1.d0-dbleif)
    F(i,3) = -vadt * ( U(ixp,jyp,kzp,3) - depend*grdU(i+1,3) )* dbleif &
    -vadt * ( U(ix ,jy ,kz ,3) + depend*grdU(i  ,3) )* (1.d0-dbleif)
    F(i,4) = -vadt * ( U(ixp,jyp,kzp,4) - depend*grdU(i+1,4) )* dbleif &
    -vadt * ( U(ix ,jy ,kz ,4) + depend*grdU(i  ,4) )* (1.d0-dbleif)
    F(i,5) = -vadt * ( U(ixp,jyp,kzp,5) - depend*grdU(i+1,5) )* dbleif &
    -vadt * ( U(ix ,jy ,kz ,5) + depend*grdU(i  ,5) )* (1.d0-dbleif)
    F(i,6) = -vadt * ( Blg(ixp,jyp,kzp,1) - depend*grdU(i+1,12) )* dbleif &
    -vadt * ( Blg(ix ,jy ,kz ,1) + depend*grdU(i  ,12) )* (1.d0-dbleif)
    F(i,7) = -vadt * ( Blg(ixp,jyp,kzp,2) - depend*grdU(i+1,13) )* dbleif &
    -vadt * ( Blg(ix ,jy ,kz ,2) + depend*grdU(i  ,13) )* (1.d0-dbleif)
    G(i,1) = -vadt * (   ndH(ixp,jyp,kzp) - depend*grdC(i+1,1) )* dbleif &
    -vadt * (   ndH(ix ,jy ,kz ) + depend*grdC(i  ,1) )* (1.d0-dbleif)
    G(i,2) = -vadt * (   ndp(ixp,jyp,kzp) - depend*grdC(i+1,2) )* dbleif &
    -vadt * (   ndp(ix ,jy ,kz ) + depend*grdC(i  ,2) )* (1.d0-dbleif)
    G(i,3) = -vadt * (  ndH2(ixp,jyp,kzp) - depend*grdC(i+1,3) )* dbleif &
    -vadt * (  ndH2(ix ,jy ,kz ) + depend*grdC(i  ,3) )* (1.d0-dbleif)
    G(i,4) = -vadt * (  ndHe(ixp,jyp,kzp) - depend*grdC(i+1,4) )* dbleif &
    -vadt * (  ndHe(ix ,jy ,kz ) + depend*grdC(i  ,4) )* (1.d0-dbleif)
    G(i,5) = -vadt * ( ndHep(ixp,jyp,kzp) - depend*grdC(i+1,5) )* dbleif &
    -vadt * ( ndHep(ix ,jy ,kz ) + depend*grdC(i  ,5) )* (1.d0-dbleif)
    G(i,6) = -vadt * (   ndC(ixp,jyp,kzp) - depend*grdC(i+1,6) )* dbleif &
    -vadt * (   ndC(ix ,jy ,kz ) + depend*grdC(i  ,6) )* (1.d0-dbleif)
    G(i,7) = -vadt * (  ndCp(ixp,jyp,kzp) - depend*grdC(i+1,7) )* dbleif &
    -vadt * (  ndCp(ix ,jy ,kz ) + depend*grdC(i  ,7) )* (1.d0-dbleif)
    G(i,8) = -vadt * (  ndCO(ixp,jyp,kzp) - depend*grdC(i+1,8) )* dbleif &
    -vadt * (  ndCO(ix ,jy ,kz ) + depend*grdC(i  ,8) )* (1.d0-dbleif)
    G(i,9) = -vadt * (  ndHm(ixp,jyp,kzp) - depend*grdC(i+1,9) )* dbleif &
    -vadt * (  ndHm(ix ,jy ,kz ) + depend*grdC(i  ,9) )* (1.d0-dbleif)
    G(i,10) = -vadt * (  ndO(ixp,jyp,kzp) - depend*grdC(i+1,10) )* dbleif &
    -vadt * (  ndO(ix ,jy ,kz ) + depend*grdC(i  ,10) )* (1.d0-dbleif)
    G(i,11) = -vadt * (  ndfgr(ixp,jyp,kzp) - depend*grdC(i+1,11) )* dbleif &
    -vadt * (  ndfgr(ix ,jy ,kz ) + depend*grdC(i  ,11) )* (1.d0-dbleif)
  !else  !*** va > 0
    ...
    !G(i,11) = -vadt * (  ndfgr(ix ,jy ,kz ) + depend*grdC(i  ,11) )
  !end if
end do
...
do i = 1, Ncell
  ...
  ndHep(ix,jy,kz) = ( ndHep(ix,jy,kz)*dxlag(i) + G(i,5) - G(i-1,5) )/( xelr(i) - xelr(i-1) )
   ...
   ndfgr(ix,jy,kz)= ( ndfgr(ix,jy,kz)*dxlag(i) + G(i,11)- G(i-1,11))/( xelr(i) - xelr(i-1) )
end do
...
fesO1 = (0.5d0+dsign(0.5d0,0.1d0-1.d-16-tO1))*(0.5d0-0.585d0*tO1+0.4563d0*tO1**2) &
...
fesO2 = (0.5d0+dsign(0.5d0,0.1d0-1.d-16-tO2))*(0.5d0-0.585d0*tO2+0.4563d0*tO2**2) &
...
dbleif_g = 0.5d0+dsign(0.5d0,Tn(i,j,k)-1.d-2)
  LamH2H = ( -16.818d0+37.384d0*dlog10(Tn(i,j,k))+58.145d0*(dlog10(Tn(i,j,k)))**2+48.656d0*(dlog10(Tn(i,j,k)))**3 &
...
dbleif_g = 0.5d0+dsign(0.5d0,Tn(i,j,k)-1.d-1)
  LamH2H = ( -24.311d0+3.569d0*dlog10(Tn(i,j,k))-11.333d0*(dlog10(Tn(i,j,k)))**2-27.85d0*(dlog10(Tn(i,j,k)))**3 &
...
!if((T.gt.1.d0).and.(T.le.6.d0)) then
  ...
  LamH2H = ( -24.311d0+4.645d0*dlog10(Tn(i,j,k))-3.721d0*(dlog10(Tn(i,j,k)))**2+5.937d0*(dlog10(Tn(i,j,k)))**3 &
...
!if((T.gt.1.d-1).and.(T.le.6.d0)) then
  dbleif_l = 0.5d0-dsign(0.5d0,Tn(i,j,k)-6.d0 )
  dbleif_g = 0.5d0+dsign(0.5d0,Tn(i,j,k)-1.d-1)
  LamH2H2 = ( -23.962d0+2.094d0*dlog10(Tn(i,j,k))-0.7715d0*(dlog10(Tn(i,j,k)))**2+0.4369d0*(dlog10(Tn(i,j,k)))**3 &
...
!if((T.gt.1.d-2).and.(T.le.1.d1)) then
  ...
  dbleif_g = 0.5d0+dsign(0.5d0,Tn(i,j,k)-1.d-2)
  LamH2p = ( -22.089523d0+1.5714711d0*dlog10(Tn(i,j,k))+0.015391166d0*(dlog10(Tn(i,j,k)))**2-0.23619985d0*(dlog10(Tn(i,j,k)))**3 &
...
!if((T.gt.1.d-2).and.(T.le.6.d0)) then
  dbleif_l = 0.5d0-dsign(0.5d0,Tn(i,j,k)-6.d0 )
  dbleif_g = 0.5d0+dsign(0.5d0,Tn(i,j,k)-1.d-2)
  LamH2He = ( -23.689d0+2.189d0*dlog10(Tn(i,j,k))-0.8152d0*(dlog10(Tn(i,j,k)))**2+0.29d0*(dlog10(Tn(i,j,k)))**3 &
...
!if((T.gt.1.d-1).and.(T.le.5.d-1)) then
  ...
  dbleif_g = 0.5d0+dsign(0.5d0,Tn(i,j,k)-1.d-1)
  LamH2e = ( -21.928796d0+16.815730d0*dlog10(Tn(i,j,k))+96.743155d0*(dlog10(Tn(i,j,k)))**2+343.19180d0*(dlog10(Tn(i,j,k)))**3 &
...
!if((Tn(i,j,k).gt.5.d-1).and.(T.le.1.d1)) then
  ...
  LamH2e = ( -22.921189d0+1.6802758d0*dlog10(Tn(i,j,k))+0.93310622d0*(dlog10(Tn(i,j,k)))**2+4.0406627d0*(dlog10(Tn(i,j,k)))**3 &
...
LCIE=Mtl_CL*Zmetals(k)*ndfgr(i,j,k)/ndtot(i,j,k) *1.9733d27  * ndHtot * ndHtot * ndHtot / Zmetals(1) * dbleif_l * dbleif_g &
  +LCIE 
enddo
!else
!LCIEHe=0.d0
...
double precision :: tNtot,tNH2,tNC,tNCO,ttau,dxh,tNO,tNfgr
