module comvar
  implicit none
  integer, parameter :: ndx=258,ndy=258,laststep=5000,istx=1,ienx=2,isty=1,ieny=2,svnum=50, dim=4 !preiodic:ist=1,ien=2 , kotei:ist=2,ien=3 : ndx=130
...
module grvvar
  implicit none
  integer, parameter :: ndx2=258 , ndy2=258 , dim2=4 !パラメータ属性必要
...
subroutine saveu(in1)
  ...
  do j=1,ndy-2
     do i=1,ndx-2
        write(21,*) x(i),y(j),wp1(i,j,1),wp1(i,j,2),wp1(i,j,3),wp1(i,j,4),wp2(i,j,1),wp2(i,j,2),wp2(i,j,3),wp2(i,j,4)&
