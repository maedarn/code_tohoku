...
DOUBLE PRECISION, parameter :: cg=1.0d0,sourratio=0.5d0,adiff=0.375d0,rratio=0.20d0,tratio=1.0d0,rmove=35.d0
...
character(36) :: dir='/work/maedarn/3DMHD/tel/tel-mesh064/'
character(7) :: svdir
END MODULE comvar
