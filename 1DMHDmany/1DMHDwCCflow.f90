...
call bc2()
 call VLIMIT(Ncell,U(-1,1),grdQ(-1,1),dx,0,1)
 call VLIMIT(Ncell,U(-1,2),grdQ(-1,2),dx,0,1)
 call VLIMIT(Ncell,U(-1,5),grdQ(-1,5),dx,0,1)
 call VLIMIT(Ncell,U(-1,7),grdQ(-1,7),dx,0,1)
 call VLIMIT(Ncell,U(-1,8),grdQ(-1,8),dx,0,1)
...
call bc2()
 call VLIMIT(Ncell,U(-1,1),grdU(-1,1),dxlag,0,1)
 call VLIMIT(Ncell,U(-1,2),grdU(-1,2),dxlag,0,1)
 call VLIMIT(Ncell,U(-1,3),grdU(-1,3),dxlag,0,1)
 call VLIMIT(Ncell,U(-1,4),grdU(-1,4),dxlag,0,1)
 call VLIMIT(Ncell,U(-1,5),grdU(-1,5),dxlag,0,1)
 call VLIMIT(Ncell,U(-1,7),grdU(-1,7),dxlag,0,1)
 call VLIMIT(Ncell,U(-1,8),grdU(-1,8),dxlag,0,1)
 
 call VLIMIT(Ncell,  ndH(-1),grdC(-1,1),dxlag,0,1)
 call VLIMIT(Ncell,  ndp(-1),grdC(-1,2),dxlag,0,1)
 call VLIMIT(Ncell, ndH2(-1),grdC(-1,3),dxlag,0,1)
 call VLIMIT(Ncell, ndHe(-1),grdC(-1,4),dxlag,0,1)
 call VLIMIT(Ncell,ndHep(-1),grdC(-1,5),dxlag,0,1)
 call VLIMIT(Ncell,  ndC(-1),grdC(-1,6),dxlag,0,1)
 call VLIMIT(Ncell, ndCp(-1),grdC(-1,7),dxlag,0,1)
 call VLIMIT(Ncell, ndCO(-1),grdC(-1,8),dxlag,0,1)
...
CooL = U(i,1)*heat - U(i,1) * KIcool * ndH(i)
