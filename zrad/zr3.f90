...
pi=3.14159265358979d0,sigma_B=5.67d-5
double precision :: yHe=8.333d-2
double precision :: rmasse=9.109534d-28,rmassp=1.67d-24
double precision :: T_ro=575.d0,c_light=2.99792458d10,h_Pl=6.62618d-27
integer, PARAMETER :: N_sp=50, maxit=100, N_p=100, N_react=675 !Species, itr in chemcool, 
END MODULE
...
!-----INCLUDES------
!-------------------
include "subs2/chemistry.f90"
include "subs2/reaction.f90"  !full reactions
include "subs2/grain.f90"
include "subs2/xk_prm.f90"
include "subs2/H2.f90"
include "subs2/HD.f90"
include "subs2/lines.f90"
include "subs2/CR.f90"
include "subs2/math.f90"
include "subs2/CO.f90"
include "subs2/H2O.f90"
include "subs2/OH.f90"
...
open(8,file='data2/nT_z2_nm1_GZ0u.dat',status='unknown')
open(11,file='data2/1_z2_nm1_GZ0u.dat',status='unknown')
open(12,file='data2/2_z2_nm1_GZ0u.dat',status='unknown')
!open(13,file='3.dat',status='unknown')    
open(14,file='data2/4_z2_nm1_GZ0u.dat',status='unknown')
open(15,file='data2/data_y_z2_nm1_GZ0u.dat',status='unknown')
...
SUBROUTINE line_cool(y,radius,xLmbd_line,i)
   ...
   USE PYSCONST
IMPLICIT REAL*8(a-h,o-z)
double precision :: y(N_sp),func(N_p),&
