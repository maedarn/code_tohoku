...
!*****************
 gamma = 2.0d0 !http://www.astro.phys.s.chiba-u.ac.jp/netlab/cans/cans1d/md_mhdshktb/index.html#
!*****************
...
open(10,file=dir//filenm//'.dat')
   write(10,100) ( 0.5d0*(x(i)+x(i-1)),U(i,1),U(i,2),U(i,3),U(i,4),U(i,5),U(i,6),U(i,7),U(i,8), &
                   ndH(i),ndp(i),ndH2(i),ndHe(i),ndHep(i),ndC(i),ndCO(i),ndCp(i),time,i=1,Ncell )
close(10)
...
!   write(*,*) 'time = ',time
  ...
  open(10,file=dir//'000.dat',FORM='UNFORMATTED') !CONVERT='LITTLE_ENDIAN'
    write(10) ( x(i),U(i,1),U(i,2),U(i,3),U(i,4),U(i,5),U(i,6),U(i,7),U(i,8), &
                ndH(i),ndp(i),ndH2(i),ndHe(i),ndHep(i),ndC(i),ndCO(i),ndCp(i),time,i=-1,Ncell+2 )
  close(10)
end if
