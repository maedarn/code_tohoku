...
double precision :: Phiwvpre(-2:ndx+1,-2:ndy+1,-2:ndz+1,1:2),Phigrdwvpre(-2:ndx+1,-2:ndy+1,-2:ndz+1,1:2)
  ...
  iwx=1;iwy=0;iwz=0
   call BCgrv(100,1,8)
   !Phiwvtest(:,:,:)=NRANK
   call muslcslv1D(Phiwv(-2,-2,-2,1),dt  *0.5d0,1)
   !call muslcslv1D(Phiwvtest,dt*0.25d0,1)
   call muslcslv1D(Phiwv(-2,-2,-2,2),dtt2*0.5d0,2)
   ...
   call BCgrv(100,1,8)
   call muslcslv1D(Phiwv(-2,-2,-2,1),dt  *0.5d0,1)
   call muslcslv1D(Phiwv(-2,-2,-2,2),dtt2*0.5d0,1)
   !call muslcslv1D(Phiwv(-2,-2,-2,3),dt*0.25d0,1)
   !call muslcslv1D(Phiwv(-2,-2,-2,4),dt*0.25d0,1)
   ...
   Phiwvpre(:,:,:,1)=Phiwv(:,:,:,1)
   Phiwvpre(:,:,:,2)=Phiwv(:,:,:,2)
   Phigrdwvpre(:,:,:,1)=Phigrdwv(:,:,:,1)
   Phigrdwvpre(:,:,:,2)=Phigrdwv(:,:,:,2)
