...
program main
  ...
  integer i,j,k,Vb,r,m,mm,in,loop,ii,nsisu
...
!  close(290)
  ...
  write(num,'(i3.3)') ii
  open(110,file='/Users/maeda/Desktop/kaiseki/image/taglog'//num//'.DAT',FORM='FORMATTED')
  do k=1,nz
     do j=1,ny
        do i=1,nx
  ...
  open(120,file='/Users/maeda/Desktop/kaiseki/image/rgn.DAT',FORM='FORMATTED')
  do i=1,loop
