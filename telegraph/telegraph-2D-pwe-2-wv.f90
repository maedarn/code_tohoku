...
wppre2(:,:,:)=wp2(:,:,:)
    ...
    do k=1,ndy-2
      do j=1,ndx-2
wp2(j,k,1) = 0.5d0*wp2(j,k,1)*(1.d0+dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,1)*(1.d0-dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(-1.d0+dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0*(dt)
wp2(j,k,2) = 0.5d0*wp2(j,k,2)*(1.d0+dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,2)*(1.d0-dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(-1.d0+dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0*(dt)
wp2(j,k,3) = 0.5d0*wp2(j,k,3)*(1.d0+dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,3)*(1.d0-dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(-1.d0+dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0*(dt)
wp2(j,k,4) = 0.5d0*wp2(j,k,4)*(1.d0+dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,4)*(1.d0-dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(-1.d0+dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0*(dt)
      enddo
    enddo
    endif
    ...
    do k=1,ndy-2
      do j=1,ndx-2
grdxy1=adiff*wppre2(j+1,k+1,1)+adiff*wppre2(j-1,k-1,1)+(adiff-0.5d0)*wppre2(j+1,k-1,1)+(adiff-0.5d0)*wppre2(j-1,k+1,1) &
+(4.d0*adiff-1.d0)*wppre2(j,k,1)+(-2.d0*adiff+0.5d0)*wppre2(j+1,k,1)+(-2.d0*adiff+0.5d0)*wppre2(j,k+1,1)+&
(-2.d0*adiff+0.5d0)*wppre2(j-1,k,1)+(-2.d0*adiff+0.5d0)*wppre2(j,k-1,1)

grdxy1=(-(-wppre2(j+2,k+2,1)+8.d0*wppre2(j+2,k+1,1)-8.d0*wppre2(j+2,k-1,1)+wppre2(j+2,k-2,1))/12.d0 &
   +8.d0*(-wppre2(j+1,k+2,1)+8.d0*wppre2(j+1,k+1,1)-8.d0*wppre2(j+1,k-1,1)+wppre2(j+1,k-2,1))/12.d0 &
   -8.d0*(-wppre2(j-1,k+2,1)+8.d0*wppre2(j-1,k+1,1)-8.d0*wppre2(j-1,k-1,1)+wppre2(j-1,k-2,1))/12.d0 &
        +(-wppre2(j-2,k+2,1)+8.d0*wppre2(j-2,k+1,1)-8.d0*wppre2(j-2,k-1,1)+wppre2(j-2,k-2,1))/12.d0 &
        )/12.d0


grdxy2=adiff*wppre2(j+1,k+1,2)+adiff*wppre2(j-1,k-1,2)+(adiff-0.5d0)*wppre2(j+1,k-1,2)+(adiff-0.5d0)*wppre2(j-1,k+1,2) &
+(4.d0*adiff-1.d0)*wppre2(j,k,2)+(-2.d0*adiff+0.5d0)*wppre2(j+1,k,2)+(-2.d0*adiff+0.5d0)*wppre2(j,k+1,2)+&
(-2.d0*adiff+0.5d0)*wppre2(j-1,k,2)+(-2.d0*adiff+0.5d0)*wppre2(j,k-1,2)

grdxy3=adiff*wppre2(j+1,k+1,3)+adiff*wppre2(j-1,k-1,3)+(adiff-0.5d0)*wppre2(j+1,k-1,3)+(adiff-0.5d0)*wppre2(j-1,k+1,3) &
+(4.d0*adiff-1.d0)*wppre2(j,k,3)+(-2.d0*adiff+0.5d0)*wppre2(j+1,k,3)+(-2.d0*adiff+0.5d0)*wppre2(j,k+1,3)+&
(-2.d0*adiff+0.5d0)*wppre2(j-1,k,3)+(-2.d0*adiff+0.5d0)*wppre2(j,k-1,3)

grdxy4=adiff*wppre2(j+1,k+1,4)+adiff*wppre2(j-1,k-1,4)+(adiff-0.5d0)*wppre2(j+1,k-1,4)+(adiff-0.5d0)*wppre2(j-1,k+1,4) &
+(4.d0*adiff-1.d0)*wppre2(j,k,4)+(-2.d0*adiff+0.5d0)*wppre2(j+1,k,4)+(-2.d0*adiff+0.5d0)*wppre2(j,k+1,4)+&
(-2.d0*adiff+0.5d0)*wppre2(j-1,k,4)+(-2.d0*adiff+0.5d0)*wppre2(j,k-1,4)
...
wp1(j,k,1) = 0.5d0*wppre2(j,k,1)*(1.d0-dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,1)*(1.d0+dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(1.d0-dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0* (dt)
wp1(j,k,2) = 0.5d0*wppre2(j,k,2)*(1.d0-dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,2)*(1.d0+dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(1.d0-dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0* (dt)
wp1(j,k,3) = 0.5d0*wppre2(j,k,3)*(1.d0-dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,3)*(1.d0+dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(1.d0-dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0* (dt)
wp1(j,k,4) = 0.5d0*wppre2(j,k,4)*(1.d0-dexp(-1.d0/Tdiff * dt))+0.5d0*wp1(j,k,4)*(1.d0+dexp(-1.0d0/Tdiff * dt))+&
(-cg*cg*Tdiff*Tdiff*G4pi*rho(j,k))*(1.d0-dexp(-1.0d0/Tdiff * dt))-cg*cg*2.d0*Tdiff*G4pi*rho(j,k)*0.5d0* (dt)
