...
do j=0,nz; n = j + kk
  temp2(1 ,j,k) = bphi4(n,1)
end do;end do
call collect( temp1,temp2,n1,n1,n1,nx,ny,nz )
do k=1,n1; kk = n1*(k-1) + pointb1(NGcr)
do j=1,n1; n = j-1 + kk
  bphi3(n,1) = temp1(1 ,j,k)
end do;end do

do k=0,ny; kk = (nx+1)*k + pointb2(NGcr)
do j=0,nx; n = j + kk
  temp2(1 ,j,k) = bphi6(n,1)
end do;end do
call collect( temp1,temp2,n1,n1,n1,nx,ny,nz )
do k=1,n1; kk = n1*(k-1) + pointb1(NGcr)
do j=1,n1; n = j-1 + kk
  bphi5(n,1) = temp1(1 ,j,k)
end do;end do
...
do k=0,nx; kk = (nz+1)*k + pointb2(NGcr)
do j=0,nz; n = j + kk
  temp2(ny,j,k) = bphi4(n,2)
end do;end do
call collect( temp1,temp2,n1,n1,n1,nx,ny,nz )
do k=1,n1; kk = n1*(k-1) + pointb1(NGcr)
do j=1,n1; n = j-1 + kk
  bphi3(n,2) = temp1(n1,j,k)
end do;end do

do k=0,ny; kk = (nx+1)*k + pointb2(NGcr)
do j=0,nx; n = j + kk
  temp2(nz,j,k) = bphi6(n,2)
end do;end do
call collect( temp1,temp2,n1,n1,n1,nx,ny,nz )
do k=1,n1; kk = n1*(k-1) + pointb1(NGcr)
do j=1,n1; n = j-1 + kk
  bphi5(n,2) = temp1(n1,j,k)
end do;end do
