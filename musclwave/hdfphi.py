...
for i in range(itime,ftime +1,timejump): #最後は含まない
    ...
    with h5py.File(dir+'All/AllHDF'+"%03.f"%(i)+'.h5', 'w') as f:
        ...
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa1', data=slice18)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa2', data=slice19)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa3', data=slice20)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa4', data=slice21)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa5', data=slice22)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa6', data=slice23)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa7', data=slice24)
        f['Phigrdwvexa'].create_dataset('Phigrdwvexa8', data=slice25)
