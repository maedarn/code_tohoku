...
character(31) :: dir='/work/maedarn/3DMHD/samplecnv8/' !samplecnv2
END MODULE comvar
...
!***** CT part *****
    ...
    call CC(1,dt)
    if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-a'
    ALLOCATE(dnc(-1:ndx,-1:ndy,-1:ndz)); ALLOCATE(EMF(-1:ndx,-1:ndy,-1:ndz,3))
    iwx=1; iwy=0; iwz=0; call CC(2,dt)
if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-b'
call CCT(dx,dy,dt) !calculate Ez
if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-c'
iwx=0; iwy=1; iwz=0; call CC(2,dt)
if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-d'
call CCT(dy,dz,dt) !calculate Ex
if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-e'
iwx=0; iwy=0; iwz=1; call CC(2,dt)
if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-f'
call CCT(dz,dx,dt) !calculate Ey
if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-g'
    DEALLOCATE(Vfc); DEALLOCATE(dnc)

    call CC(3,dt)
    if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-h'
    DEALLOCATE(EMF)
    call CC(4,dt)
    if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point5-i'
...
CALL BC_MPI(2,1)
N_MPI(10) = 10; CALL BC_MPI_OT(2,1); N_MPI(10) = 0
iwx=pwx
iwy=pwy
iwz=pwz
DEALLOCATE(Blg)
