...
open(8,file='data2/nT_z6.dat',status='unknown')
open(11,file='data2/1_z6.dat',status='unknown')
open(12,file='data2/2_z6.dat',status='unknown')
!open(13,file='3.dat',status='unknown')    
open(14,file='data2/4_z6.dat',status='unknown')
open(15,file='data2/data_y_z6.dat',status='unknown')
