SUBROUTINE GRAVTY(dt,mode)
  ...
  INTEGER :: LEFTt,RIGTt,TOPt,BOTMt,UPt,DOWNt,i,j,k
  ...
  if(mode.eq.3) then !acceraration because of gravity
     ...
     !goto 10108
     !   if(TEST1==0) then
     !      write (TNAME,'("PHI",i3.3,i3.3,".dat")') TEST1,NRANK
     !      open (103, file=TNAME)
     !      do k=1,Ncellz; do j=1,Ncelly; do i=1,Ncellx
     !         write(103,*) i,j,k,Phi(i,j,k),U(i,j,k,1)
     ...
     do k=1,Ncellz; do j=1,Ncelly; do i=1,Ncellx
        ...
        !      write(103,*) i,j,k,Phi(i,j,k),U(i,j,k,1)
        if(NRANK==40 .and. k==1 .and. j==1) then
           write(*,*) i,j,k,Phi(i,j,k),U(i,j,k,1),'=====grv=====' 
        end if
     end do;end do;end do
     !   TEST1=TEST1+1
     !   close(103)
...
SUBROUTINE mglin(Need1,Need2,ncycle,NPRE,NPOST)
  ...
  character(5) name
  integer :: countin = 0,ooo=0,oo=2,jMPI=1000,jnoMPI=1000
  double precision :: msrs=1.0d5
  ...
  do k=0,Ncellz+1; kk=(Ncellx+2)*(Ncelly+2)*k+point2(NGL)
     do j=0,Ncelly+1; jj=(Ncellx+2)*j+kk
        ...
        if(NRANK==40) then
           write (name,'(i5.5)') countin
           open(51,file='zz'//name//'rst1.dat')

           do kkkk=1,Ncellz
              do jjjj=1,Ncelly
                 do iiii=1,Ncellx
                    write(51,*) iiii,jjjj,kkkk,crhs2(point2(NGL) + kkkk*iiii*jjjj-1)
                 end do
              end do
           end do
           close(51)
        ...
        call rstrctMPI(crho2(point2(ngrid)),crhs2(point2(ngrid+1)),ncx,ncy,ncz,0,NRANK)



        if(NRANK==40) then
           write (name,'(i5.5)') countin
           open(58,file='zz'//name//'rst2.dat')

           do kkkk=1,ncz
              do jjjj=1,ncy
                 do iiii=1,ncx
                    write(58,*) iiii,jjjj,kkkk,crho2(point2(ngrid)+kkkk*iiii*jjjj-1)
                 end do
              end do
           end do
           close(58)
        ...
        do while(ngrid.ne.NGcr)
           ...
           if(NRANK==40) then
              write (name,'(i5.5)') countin
              open(60,file='zz'//name//'rst3.dat')

              do kkkk=1,ncx
                 do jjjj=1,ncy
                    do iiii=1,ncz
                       write(60,*) iiii,jjjj,kkkk,crho2(point2(ngrid) + kkkk*iiii*jjjj-1)
                    end do
                 end do
              end do
              close(60)
           ...
           call rstrctMPI(crho2(point2(ngrid)),crho2(point2(ngrid+1)),ncx,ncy,ncz,0,NRANK)
           ...
           if(NRANK==40) then
              write (name,'(i5.5)') countin
              open(61,file='zz'//name//'rst4.dat')

              do kkkk=1,ncx
                 do jjjj=1,ncy
                    do iiii=1,ncz
                       write(61,*) iiii,jjjj,kkkk,crho2(point2(ngrid)+kkkk*iiii*jjjj-1)
                    end do
                 end do
              end do
              close(61)
...
write(*,*) ncx,ngrid,'============ncxcr=============='
        ...
        if(NRANK==40) then
           write (name,'(i5.5)') countin
           open(62,file='zz'//name//'cll1.dat')

           do kkkk=1,nczcr
              do jjjj=1,ncycr
                 do iiii=1,ncxcr
                    write(62,*) iiii,jjjj,kkkk,crho2(point2(NGcr)+kkkk*iiii*jjjj-1)
                 end do
              end do
           end do
           close(62)
        ...
        if(NRANK==40) then
           write (name,'(i5.5)') countin
           open(63,file='zz'//name//'cll2.dat')

           do kkkk=1,ncz
              do jjjj=1,ncy
                 do iiii=1,ncx
                    write(63,*) iiii,jjjj,kkkk,crho1(point1(NGcr)+kkkk*iiii*jjjj-1)
                 end do
              end do
           end do
           close(63)
        ...
        do while(ngrid.ne.1)
           ...
           if(NRANK==40) then
              ...
              write (name,'(i5.5)') countin
              open(65,file='zz'//name//'rst-1.dat')

              do kkkk=1,ncz
                 do jjjj=1,ncy
                    do iiii=1,ncx
                       write(65,*) iiii,jjjj,kkkk,crho1(point1(ngrid)+kkkk*iiii*jjjj-1)
                    end do
                 end do
              end do
              close(65)
           ...
           if(NRANK==40) then
              write (name,'(i5.5)') countin
              open(66,file='zz'//name//'rst-2.dat')

              do kkkk=1,ncx
                 do jjjj=1,ncx
                    do iiii=1,ncx
                       write(66,*) iiii,jjjj,kkkk,crho1(point1(ngrid)+kkkk*iiii*jjjj-1 )
                    end do
                 end do
              end do
              close(66)
         ...
         write(*,*) ngrid,ncx,ncxcr,NRANK,'=============ncx============'

        call slvsmlb(cphi1(point1(1)),crho1(point1(1)),NRANK) !BC set is necessary
        ...
        do j=2,ngrid
           ...
           IF(j.le.NGcr) THEN !*** generate candidate sol. from j-1 to j (upward) *** 
              ...
              if(NRANK==40) then
                 write (name,'(i5.5)') countin
                 open(67,file='zz'//name//'intcpy1.dat')

                 do kkkk=1,ncz
                    do jjjj=1,ncy
                       do iiii=1,ncx
                          write(67,*) iiii,jjjj,kkkk,cphi1(point1(j-1)+kkkk*iiii*jjjj-1)
                       end do
                    end do
                 end do
                 close(67)
              ...
              if(NRANK==40) then
                 write (name,'(i5.5)') countin
                 open(68,file='zz'//name//'intcpy2.dat')

                 do kkkk=1,ncz
                    do jjjj=1,ncy
                       do iiii=1,ncx
                          write(68,*) iiii,jjjj,kkkk,cphi1(point1(j)+iiii*kkkk*jjjj-1),crhs1(point1(j)+iiii*kkkk*jjjj-1),crho1(point1(j)+iiii*kkkk*jjjj-1)
                       end do
                    end do
                 end do
                 close(68)
              ...
              if(j.eq.NGcr) then
                 ...
                 if(NRANK==40) then
                    ...
                    write (name,'(i5.5)') countin
                    open(69,file='zz'//name//'divcpy1.dat')

                    do kkkk=1,ncz
                       do jjjj=1,ncy
                          do iiii=1,ncx
                             write(69,*) iiii,jjjj,kkkk,cphi1(point1(j)+iiii*kkkk*jjjj-1)
                          end do
                       end do
                    end do
                    close(69)
                 ...
                 if(NRANK==40) then
                    ...
                    open(70,file='zz'//name//'divcpy2.dat')

                    do kkkk=1,ncz
                       do jjjj=1,ncy
                          do iiii=1,ncx
                             write(70,*) iiii,jjjj,kkkk,cphi2(point2(j)+iiii*kkkk*jjjj-1),crhs2(point2(j)+iiii*kkkk*jjjj-1),crho2(point2(j)+iiii*kkkk*jjjj-1)
                          end do
                       end do
                    end do
                    close(70)
           ...
           ELSE
              ...
              if(NRANK==40) then
                 ...
                 write (name,'(i5.5)') countin
                 open(71,file='zz'//name//'intcpympi1.dat')

                 do kkkk=1,ncz
                    do jjjj=1,ncy
                       do iiii=1,ncx
                          write(71,*) iiii,jjjj,kkkk,cphi2(point2(j-1)+iiii*kkkk*jjjj-1)
                       end do
                    end do
                 end do
                 close(71)
              ...
              if(NRANK==40) then
                 write (name,'(i5.5)') countin
                 open(72,file='zz'//name//'intcpympi2.dat')

                 do kkkk=1,ncz
                    do jjjj=1,ncy
                       do iiii=1,ncx
                          write(72,*) iiii,jjjj,kkkk,cphi2(point2(j)+iiii*kkkk*jjjj-1),crhs2(point2(j)+iiii*kkkk*jjjj-1),crho2(point2(j)+iiii*kkkk*jjjj-1)
                       end do
                    end do
                 end do
                 close(72)
                 ...
                 IF(jj.lt.NGcr) THEN !*** generate residual from jj to jj-1 ****
                    do jpre=1,NPRE+jnoMPI
                       ...
                       if(NRANK==40) then
                          ...
                          write(*,*)
                          write(*,*) jpre,NPRE,jj,jcycle,j,nfx,'==========pos1-1=========='
                          write(*,*)


                          write (name,'(i5.5)') countin
                          open(53,file='zz'//name//'rlx1.dat')

                          do kkkk=1,nfx
                             do jjjj=1,nfy
                                do iiii=1,nfz
                                   write(53,*) mode,iiii,jjjj,kkkk,cphi1(point1(jj)+iiii*kkkk*jjjj-1),crhs1(point1(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(53)
                       ...
                       call relax(cphi1(point1(jj)),crhs1(point1(jj)),nfx,nfy,nfz,mode,oo,1,NRANK,msrs,jpre)


                       if(NRANK==40) then
                          oo=2
                          open(54,file='zz'//name//'rlx2.dat')

                          do kkkk=1,nfx
                             do jjjj=1,nfy
                                do iiii=1,nfz
                                   write(54,*) mode,iiii,jjjj,kkkk,cphi1(point1(jj)+iiii*kkkk*jjjj-1),crhs1(point1(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(54)
                       ...
                       if(msrs < 1.0-2) then
                          call relax(cphi1(point1(jj)),crhs1(point1(jj)),nfx,nfy,nfz,mode,4,1,NRANK,msrs,jpre)
                          goto 2999
                       end if
                    end do
2999                continue
                    ...
                    if(NRANK==40) then
                       write (name,'(i5.5)') countin
                       open(75,file='zz'//name//'rrf1.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(75,*) iiii,jjjj,kkkk,cphi1(point1(jj)+iiii*kkkk*jjjj-1),crhs1(point1(jj)+iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(75)
                    ...
                    call resid(cres1(point1(jj)),cphi1(point1(jj)),crhs1(point1(jj)),nfx,nfy,nfz,NRANK)
                    ...
                    if(NRANK==40) then
                       write (name,'(i5.5)') countin
                       open(76,file='zz'//name//'rrf2.dat')

                       do kkkk=1,nfz*2-1
                          do jjjj=1,nfy*2-1
                             do iiii=1,nfx*2-1
                                write(76,*) nfx, iiii,jjjj,kkkk,cres1(point1(jj)+iiii*kkkk*jjjj-1),crhs1(point1(jj-1)+(iiii/2)*(kkkk/2)*(jjjj/2)),&
                                cphi1(point1(jj-1)+(iiii/2)*(kkkk/2)*(jjjj/2))
                             end do
                          end do
                       end do
                       close(76)
                 ...
                 ELSE
                    ...
                    do jpre=1,NPRE1+jMPI
                       mode=2; if((jj.ne.j).and.(jpre.eq.1)) mode=1

                       if(NRANK==40) then
                          write(*,*) jpre,NPRE1,jj,jcycle,ncycle,j,nfx,'==========pos1=========='
                          write (name,'(i5.5)') countin
                          open(78,file='zz'//name//'rlzmpi11.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(78,*) nfx,mode,iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(78)
                       ...
                       call relaxMPI(cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,mode,ooo,1,msrs,jpre)

                       if(NRANK==40) then
                          ooo=2
                          write (name,'(i5.5)') countin
                          open(79,file='zz'//name//'rlxmpi12.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(79,*) mode,nfx,iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(79)
                       ...
                       if(msrs < 1.0-2) then
                          call relaxMPI(cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,mode,4,1,msrs,jpre)
                          goto 2799
                       end if
                    end do
2799                continue
                    ...
                    if(NRANK==40) then
                       ...
                       write (name,'(i5.5)') countin
                       open(80,file='zz'//name//'res11.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(80,*) mode,iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(80)
                    ...
                    call residMPI(cres2(point2(jj)),cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,NRANK)
                    if(NRANK==40) then
                       write (name,'(i5.5)') countin
                       open(81,file='zz'//name//'res12.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(81,*) mode,nfx,iiii,jjjj,kkkk,cres2(point2(jj) +iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(81)
                    ...
                    if(jj.eq.NGcr) then
                       ...
                       if(NRANK==40) then
                          ...
                          write (name,'(i5.5)') countin
                          open(82,file='zz'//name//'ccrf1.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(82,*) nfx,iiii,jjjj,kkkk,cphi2(point2(NGcr)+iiii*kkkk*jjjj-1),cres2(point2(NGcr)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(82)
                       ...
                       if(NRANK==40) then
                          ...
                          open(83,file='zz'//name//'ccrf2.dat')
                          write (name,'(i5.5)') countin
                          do kkkk=1,nfz*2-1
                             do jjjj=1,nfy*2-1
                                do iiii=1,nfx*2-1
                                   write(83,*) nfx,iiii,jjjj,kkkk,crhs1(point1(jj-1)+(iiii/2)*(kkkk/2)*(jjjj/2)),cphi1(point1(NGcr)+iiii*kkkk*jjjj-1), &
                                        cres1(point1(NGcr)+iiii*kkkk*jjjj-1),cphi1(point1(jj-1)+(iiii/2)*(kkkk/2)*(jjjj/2))
                                end do
                             end do
                          end do
                          close(83)
                       ...
                       if(NRANK==40) then
                          ...
                          write (name,'(i5.5)') countin
                          open(84,file='zz'//name//'rf-1.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(84,*)iiii,jjjj,kkkk,cres2(point2(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(84)
                       ...
                       nfx=nfx/2+1; nfy=nfy/2+1; nfz=nfz/2+1
                       call rstrctMPI(crhs2(point2(jj-1)),cres2(point2(jj)),nfx,nfy,nfz,1,NRANK)  !fill0 at BC below this subroutine is necessary
                       call  fill0MPI(cphi2(point2(jj-1)),nfx,nfy,nfz)
                       if(NRANK==40) then
                          write (name,'(i5.5)') countin
                          open(85,file='zz'//name//'rf-2.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(85,*) iiii,jjjj,kkkk,cphi2(point2(jj-1)+iiii*kkkk*jjjj-1),crhs2(point2(jj-1)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(85)
              ...
              if(NRANK==40) then
                 ...
                 write (name,'(i5.5)') countin
                 open(86,file='zz'//name//'slv1.dat')

                 do kkkk=1,nfz
                    do jjjj=1,nfy
                       do iiii=1,nfx
                          write(86,*) iiii,jjjj,kkkk,crhs1(point1(1)+iiii*kkkk*jjjj-1)
                       end do
                    end do
                 end do
                 close(86)
              ...
              call slvsml(cphi1(point1(1)),crhs1(point1(1)),NRANK)  !BC set is unnecessary
              if(NRANK==40) then
                 write (name,'(i5.5)') countin
                 open(87,file='zz'//name//'slv2.dat')

                 do kkkk=1,nfz
                    do jjjj=1,nfy
                       do iiii=1,nfx
                          write(87,*) iiii,jjjj,kkkk,cphi1(point1(1)+iiii*kkkk*jjjj-1)
                       end do
                    end do
                 end do
                 close(87)
              ...
              do jj=2,j             !*** UPWARD **********************************
                 ...
                 IF(jj.le.NGcr) THEN !*** generate new solution from jj-1 to jj ***
                    ...
                    if(NRANK==40) then
                       ...
                       write (name,'(i5.5)') countin
                       open(88,file='zz'//name//'addint.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(88,*) iiii,jjjj,kkkk,cphi1(point1(jj-1)+iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(88)
                    ...
                    if(NRANK==40) then
                       write (name,'(i5.5)') countin
                       open(89,file='zz'//name//'addint2.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(89,*) iiii,jjjj,kkkk,cphi1(point1(jj)+iiii*kkkk*jjjj-1),cres1(point1(jj)+iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(89)
                    ...
                    if(jj.eq.NGcr) then
                       ...
                       if(NRANK==40) then
                          ...
                          write (name,'(i5.5)') countin
                          open(90,file='zz'//name//'divid--1.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(90,*) iiii,jjjj,kkkk,cphi1(point1(NGcr)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(90)
                       ...
                       if(NRANK==40) then
                          write (name,'(i5.5)') countin
                          open(91,file='zz'//name//'divid--2.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(91,*) iiii,jjjj,kkkk,cphi2(point2(NGcr)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(91)
                       ...
                       do jpost=1,NPOST+jMPI

                          if(NRANK==40) then
                             write(*,*) jpost,NPOST,jj,jcycle,j,'==========pos222=========='

                             write (name,'(i5.5)') countin
                             open(92,file='zz'//name//'rlmpiiii1.dat')

                             do kkkk=1,nfz
                                do jjjj=1,nfy
                                   do iiii=1,nfx
                                      write(92,*) iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                                   end do
                                end do
                             end do
                             close(92)
                          ...
                          call relaxMPI(cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,2,ooo,2,msrs,jpost)
                          if(NRANK==40) then
                             ooo=2
                             write (name,'(i5.5)') countin
                             open(93,file='zz'//name//'rlmpiiii2.dat')

                             do kkkk=1,nfz
                                do jjjj=1,nfy
                                   do iiii=1,nfx
                                      write(93,*) iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                                   end do
                                end do
                             end do
                             close(93)
                          ...
                          if(msrs < 1.0-2) then
                             call relaxMPI(cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,2,4,2,msrs,jpost)
                             goto 2699
                          end if
                       end do
2699                   continue
                       ...
                       do jpost=1,NPOST+jnoMPI

                          if(NRANK==40) then
                             if(jpost==1) then
                                oo=0
                             end if
                             if(jpost==NPOST+jnoMPI) then
                                oo=4
                                 write(*,*)
                             write(*,*)
                             write(*,*) '**********************itrmax*******************',jpost
                             ...
                             write(*,*) jpost,NPOST,jj,jcycle,j,'==========pos2-1=========='
                             write (name,'(i5.5)') countin
                             open(56,file='zz'//name//'rllx3.dat')

                             do kkkk=1,nfz
                                do jjjj=1,nfy
                                   do iiii=1,nfx
                                      write(56,*) mode,iiii,jjjj,kkkk,cphi1(point1(jj)+iiii*kkkk*jjjj-1),crhs1(point1(jj)+iiii*kkkk*jjjj-1)
                                   end do
                                end do
                             end do
                             close(56)
                          ...
                          call relax(cphi1(point1(jj)),crhs1(point1(jj)),nfx,nfy,nfz,2,oo,2,NRANK,msrs,jpost)


                          if(NRANK==40) then
                             oo=2
                             open(57,file='zz'//name//'rllx4.dat')

                             do kkkk=1,nfz
                                do jjjj=1,nfy
                                   do iiii=1,nfx
                                      write(57,*) mode,iiii,jjjj,kkkk,cphi1(point1(jj)+iiii*kkkk*jjjj-1),crhs1(point1(jj)+iiii*kkkk*jjjj-1) , jpost
                                   end do
                                end do
                             end do
                             close(57)
                          ...
                          if(msrs < 1.0-2) then
                             call relax(cphi1(point1(jj)),crhs1(point1(jj)),nfx,nfy,nfz,2,4,2,NRANK,msrs,jpost)
                             goto 2899
                          end if
                       end do
2899                   continue
                 ...
                 ELSE
                    ...
                    if(NRANK==40) then!!!!!!!!!!!!!!=================================================================================================================しおり==================

                       write (name,'(i5.5)') countin
                       open(95,file='zz'//name//'adinmpi1.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(95,*) mode,iiii,jjjj,kkkk,cphi2(point2(jj-1)+iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(95)
                    ...
                    nfx=2*nfx-1; nfy=2*nfy-1; nfz=2*nfz-1
                    call addintMPI(cphi2(point2(jj)),cphi2(point2(jj-1)),cres2(point2(jj)),nfx,nfy,nfz,NRANK)  !BC set is unnecessary
                    if(NRANK==40) then
                       write (name,'(i5.5)') countin
                       open(96,file='zz'//name//'adinmpi2.dat')

                       do kkkk=1,nfz
                          do jjjj=1,nfy
                             do iiii=1,nfx
                                write(96,*) iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),cres2(point2(jj)+iiii*kkkk*jjjj-1)
                             end do
                          end do
                       end do
                       close(96)
                    ...
                    do jpost=1,NPOST1+jMPI

                       if(NRANK==40) then
                          write(*,*) jpost,NPOST1,jj,jcycle,j,'==========pos3=========='


                          write (name,'(i5.5)') countin
                          open(98,file='zz'//name//'rlxmpii1.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(98,*) mode,iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(98)
                          countin=countin+1
                          if(jpost==NPOST1+jMPI) then
                             ooo=4
                              write(*,*)
                             write(*,*)
                             write(*,*) '**********************itrmax*******************',jpost
                       ...
                       call relaxMPI(cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,2,ooo,3,msrs,jpost)
                       if(NRANK==40) then
                          ooo=2
                          write (name,'(i5.5)') countin
                          open(99,file='zz'//name//'rlxmpii2.dat')

                          do kkkk=1,nfz
                             do jjjj=1,nfy
                                do iiii=1,nfx
                                   write(99,*) mode,iiii,jjjj,kkkk,cphi2(point2(jj)+iiii*kkkk*jjjj-1),crhs2(point2(jj)+iiii*kkkk*jjjj-1)
                                end do
                             end do
                          end do
                          close(99)
                       ...
                       if(msrs < 1.0-2) then
                          call relaxMPI(cphi2(point2(jj)),crhs2(point2(jj)),nfx,nfy,nfz,2,4,3,msrs,jpost)
                          goto 2599
                       end if
                    end do
2599                continue
     ...
     do k=1,ncz; kk=(ncx+1)*(ncy+1)*k+point2(NGL)
                  ...
                  SUBROUTINE divide(u2,u1,nx2,ny2,nz2,nx1,ny1,nz1)
                    ...
                    if(NRANK==40) then
                       do kk=1,nz1
                          do jj=1,ny1
                             do ii=1,nx1
                                write(*,*) nx1,nx2,u1(ii,jj,kk),'============divide1========'
                             end do
                          end do
                       end do
                    end if
                    ...
                    do kk=kkst,nz2;k=KST*(nz2-1)+kk
                       do jj=jjst,ny2;j=JST*(ny2-1)+jj
                          do ii=iist,nx2;i=IST*(nx2-1)+ii
                             ...
                             if(NRANK==40) then
                                write(*,*) i,j,k,ii,jj,kk, u2(ii,jj,kk) , u1(i,j,k),'========================indiv================='
                             end if
                          end do;end do;end do
                        ...
                        SUBROUTINE rstrctMPI(uc,uf,nx,ny,nz,mode,a)
                          USE mpivar
                          ...
                          if(a==40)then
                                      write (name,'(i5.5)') countin
                                      open(507,file='rristiMPI'//name//'.dat')
                                      open(508,file='risMPIII'//name//'.dat')
                                      do k=0,nz
                                         do j=0,ny
                                            do i=0,nx
                                               write(507,*) i,j,k, uc(i,j,k)
                                            end do
                                            !isw=3-isw
                                         end do
                                         !isw=3-isw
                          ...
                          IF(mode.eq.1) THEN
                             ...
                             IF(IST.eq.0) THEN
                                ...
                                CALL BCsgr_MPI(uf,nx,ny,nz,1,0,1,0,1,0)
                                 ...
                                 if(NRANK==40)then
                                      write (name,'(i5.5)') countin
                                      open(507,file='INP1'//name//'.dat')
                                      open(508,file='INP2'//name//'.dat')
                                      do k=0,nz/2+1
                                         do j=0,ny/2+1
                                            do i=0,nx/2+1
                                               write(507,*) i,j,k, uc(i,j,k)
                              ...
                              SUBROUTINE interp(uf,uc,nx,ny,nz,np,mode)
                                ...
                                IF(mode.eq.1) THEN
                                 ...
                                 SUBROUTINE addintMPI(uf,uc,res,nx,ny,nz,a)
                                   ...
                                   if(a==40)then
                                      write (name,'(i5.5)') countin
                                      open(507,file='adint'//name//'.dat')
                                      open(508,file='aadint'//name//'.dat')
                                      do k=0,nz/2+1
                                         do j=0,ny/2+1
                                            do i=0,nx/2+1
                                               write(507,*) i,j,k, uc(i,j,k)
                                      ...
                                      do k=0,nz
                                         do j=0,ny
                                            do i=0,nx
                                               write(508,*) i,j,k, uf(i,j,k),res(i,j,k)
                                            end do
                                            !isw=3-isw
                                         end do
                                         !isw=3-isw
                                ...
                                !====new
                                 ...
                                 SUBROUTINE slvsml(u,rhs,a)
                                   ...
                                   if(a==40) then
                                      ...
                                      open(587,file='slv'//name//'.dat')
                                         do k=1,3
                                            do j=1,3
                                               do i=1,3
                                                  write(587,*) i,j,k,rhs(i,j,k),u(i,j,k),h
                                               end do
                                               !isw=3-isw
                                            end do
                                         end do
                                 ...
                                 SUBROUTINE slvsmlb(u,rhs,a)
                                   ...
                                   u(2,3,3) = 0.025d0* ( u(1,1,1) + u(1,1,2) + 2.d0*u(1,1,3) + u(1,2,1) + u(1,2,2) + 2.d0*u(1,2,3) + 2.d0*u(1,3,1) + 2.d0*u(1,3,2) + &
                                    ...
                                    if(a==40) then
                                      write (name,'(i4.4)') countin
                                      open(588,file='slvb'//name//'.dat')
                                         do k=1,3
                                            do j=1,3
                                               do i=1,3
                                                  write(588,*) i,j,k,rhs(i,j,k),u(i,j,k),h
                                               end do
                                               !isw=3-isw
                                            end do
                                         end do
                                 ...
                                 SUBROUTINE relaxMPI(u,rhs,nx,ny,nz,mode,ooo,pos,msrs,itrr)
                                   USE mpivar
                                   USE slfgrv
                                   double precision, parameter :: w=1.d0/6.d0
                                   double precision u(0:nx,0:ny,0:nz),rhs(0:nx,0:ny,0:nz),uold(0:nx,0:ny,0:nz)!,check(0:nx,0:ny,0:nz)
                                   double precision :: h,h2,srs,msrs,mmsrs=0.0d0
                                   integer :: shu=0,ooo,pos,itrr,itrmax=0
                                   integer :: countin=0
                                   character(4) name
                                   double precision :: bb=0.0d0,bb2=0.0d0
                                   double precision :: vv=0.0d0,vv2=0.0d0
                                   double precision :: shusoku,shusoku2
                                   ...
                                   if(NRANK==40) then
                                      write (name,'(i4.4)') countin
                                      open(51,file='rMPIpre'//name//'.dat')
                                      open(509,file='rMPIinin'//name//'.dat')
                                      open(519,file='rMPIinin2'//name//'.dat')

                                      !uold(:,:,:)=u(:,:,:)

                                      if(ooo==0) then
                                         write (name,'(i4.4)') countin
                                         open(504,file='ooo'//name//'.dat')
                                         open(505,file='ooo2'//name//'.dat')
                                      end if
                                      bb2=0
                                      do kkkk=1,nz
                                         do jjjj=1,ny
                                            do iiii=1,nx
                                              bb2=bb2+(h2*rhs(iiii,jjjj,kkkk))**2
                                            end do
                                         end do
                                      end do
                                      bb=dsqrt(bb2)
                                      ...
                                      do kkkk=1,nz
                                         do jjjj=1,ny
                                            do iiii=1,nx
                                               vv2= vv2 + (u(iiii+1,jjjj,kkkk)+u(iiii-1,jjjj,kkkk)+u(iiii,jjjj+1,kkkk)+u(iiii,jjjj-1,kkkk)+&
                                               u(iiii,jjjj,kkkk+1)+u(iiii,jjjj,kkkk-1)-h2*rhs(iiii,jjjj,kkkk))**2
                                            end do
                                         end do
                                      end do
                                      vv=dsqrt(vv2)
                                      ...
                                      do kkkk=1,nz
                                         do jjjj=1,ny
                                            do iiii=1,nx
                                               write(51,*) pos,mode,iiii,jjjj,kkkk,h2,h,Lbox,NSPLTx,nx,u(iiii,jjjj,kkkk),rhs(iiii,jjjj,kkkk)
                                            end do
                                         end do
                                      end do
                                      close(51)
                                            ...
                                            do j=1,ny-1
                                               do i=isw,nx-1,2
                                                  ...
                                                  u(i,j,k)=-w*h2*rhs(i,j,k) &
                                                       *(1.0d0-dble(ifl)) + (0.5d0+dsign(0.5d0,dble(ifl)-0.5d0))*u(i,j,k)
                                                  !		  if(NRANK.eq.0) write(*,*) 'i=',i,'ifl=',ifl
                                                  !		  if(NRANK.eq.0) write(*,*) (1-ifl),(0.5d0+dsign(0.5d0,ifl-0.5d0))

                                                  if(NRANK==40) then
                                                               write(519,*) countin,i,j,k,isw,u(i,j,k),h2,uold(i,j,k),(0.5d0+dsign(0.5d0,dble(ifl)-0.5d0)),&
                                            ...
                                            do j=1,ny-1
                                               do i=isw,nx-1,2
                                                  ...
                                                  u(i,j,k)=w*(u(i+1,j,k)+u(i-1,j,k)+u(i,j+1,k)+u(i,j-1,k)+u(i,j,k+1)+u(i,j,k-1)-h2*rhs(i,j,k)) &
                                                       *(1.0d0-dble(ifl)) + (0.5d0+dsign(0.5d0,dble(ifl)-0.5d0))*u(i,j,k)
                                                            if(NRANK==40) then
                                                               write(509,*) countin,i,j,k,isw,u(i,j,k),h2,uold(i,j,k),(0.5d0+dsign(0.5d0,dble(ifl)-0.5d0)),&
                                   ...
                                   do k=1,nz-1
                                      do j=1,ny-1
                                         do i=1,nx-1
                                            srs=dabs((u(i,j,k)-uold(i,j,k))/u(i,j,k))
                                            msrs=dmax1(srs,msrs)
                                            srs=0.0d0
                                         end do
                                      end do
                                   end do
                                   !mmsrs=dmax1(mmsrs,msrs)
                                   itrmax=max0(itrmax,itrr)

                                   if(NRANK==40) then

                                      open(52,file='rMPI'//name//'.dat')

                                      do kkkk=0,nz
                                         do jjjj=0,ny
                                            do iiii=0,nx
                                               write(52,*) iiii,jjjj,kkkk,u(iiii,jjjj,kkkk),rhs(iiii,jjjj,kkkk),(1.0d0-dble(ifl)),&
                                                    .5d0+dsign(0.5d0,dble(ifl)-0.5d0),u(iiii,jjjj,kkkk)-uold(iiii,jjjj,kkkk),uold(iiii,jjjj,kkkk),&
                                                    (u(i,j,k)-uold(i,j,k))/u(i,j,k),itrr,itrmax
                                            end do
                                         end do
                                      end do
                                      close(52)
                                      ...
                                      do kkkk=1,nz-1
                                         do jjjj=1,ny-1
                                            do iiii=1,nx-1
                                               shusoku2=(u(iiii,jjjj,kkkk)-uold(iiii,jjjj,kkkk))**2+shusoku2
                                            end do
                                         end do
                                      end do
                                      write(505,*) nx,shusoku2,pos
                                      !shusoku2=0.0d0
                                      if(ooo==4) then
                                         close(505)
                                      end if
                                      write(*,*) u(33,33,33),countin, shu, 'rMPIINcount========'
                                      countin=countin+1
                                   end if
                                 END SUBROUTINE relaxMPI


                                 SUBROUTINE relax(u,rhs,nx,ny,nz,mode,oo,pos,a,msrs,itrr)
                                   USE slfgrv
                                   double precision, parameter :: w=1.d0/6.d0
                                   double precision u(nx,ny,nz),rhs(nx,ny,nz),uold(nx,ny,nz)
                                   double precision :: h,h2,shusoku,msrs,srs,mmsrs=0.0d0
                                   integer :: countin=0,oo,pos,a,itrr,itrmax=0
                                   character(4) name
                                   ...
                                   if(oo==0) then
                                      write (name,'(i4.4)') countin
                                      open(502,file='oo'//name//'.dat')
                                   end if
                                   if(a==40) then
                                      write (name,'(i4.4)') countin
                                      open(505,file='rla1'//name//'.dat')
                                      open(506,file='rla2'//name//'.dat')
                                         do k=1,nz
                                            do j=1,ny
                                               do i=1,nx
                                                  write(505,*) i,j,k,u(i,j,k),uold(i,j,k),rhs(i,j,k)
                                               end do
                                               !isw=3-isw
                                            end do
                                         end do
                                   ...
                                   do kk=1,nz
                                      do jj=1,ny
                                         do ii=1,nx
                                            shusoku=(u(ii,jj,kk)-uold(ii,jj,kk))**2 + shusoku
                                         end do
                                      end do
                                   end do
                                   write(502,*) nx,shusoku,pos
                                   !shusoku=0.0d0
                                   if(oo==4) then
                                      close(502)
                                   endif
                                   ...
                                   if(a==40) then
                                       do k=1,nz
                                            do j=1,ny
                                               do i=1,nx
                                                  write(506,*) i,j,k,w,h2,u(i,j,k),uold(i,j,k),rhs(i,j,k),u(i,j,k)-uold(i,j,k),(u(i,j,k)-uold(i,j,k))/u(i,j,k),&
                                                       itrr,itrmax!mmsrs
                                               end do
                                               !isw=3-isw
                                            end do
                                   ...
                                   write(*,*) u(33,33,33),countin, '---11MPIINcount========'
                                   countin=countin+1

                                 END SUBROUTINE relax


                                 SUBROUTINE residMPI(res,u,rhs,nx,ny,nz,a)
                                   USE mpivar
                                   USE slfgrv
        ...
        !                              do k=1,nz,2; do j=1,ny,2 !for speed up
                                   ...
                                   if(a==40)then
                                      write (name,'(i5.5)') countin
                                      open(507,file='resss'//name//'.dat')
                                      !open(508,file='risMPIII'//name//'.dat')
                                      do k=1,nz-1
                                         do j=1,ny-1
                                            do i=1,nx-1
                                               write(507,*) IST,i,j,k,h2i,h,res(i,j,k),rhs(i,j,k),u(i,j,k),&
                                                    u(i+1,j,k)+u(i-1,j,k)+u(i,j+1,k)+u(i,j-1,k)+u(i,j,k+1)+u(i,j,k-1)-6.d0*u(i,j,k),&
                                                    -h2i*(u(i+1,j,k)+u(i-1,j,k)+u(i,j+1,k)+u(i,j-1,k)+u(i,j,k+1)+u(i,j,k-1)-6.d0*u(i,j,k)),&
                                                    -h2i*(u(i+1,j,k)+u(i-1,j,k)+u(i,j+1,k)+u(i,j-1,k)+u(i,j,k+1)+u(i,j,k-1)-6.d0*u(i,j,k))+rhs(i,j,k)
                                            end do
                                            !isw=3-isw
                                         end do
                                         !isw=3-isw
                                 ...
                                 SUBROUTINE resid(res,u,rhs,nx,ny,nz,a)
                                   USE slfgrv
                               ...
                               !    do k=1,nz,2; do j=1,ny,2 !for speed up
                                    ...
                                    if(a==40) then
                                      write (name,'(i4.4)') countin
                                      open(589,file='rees'//name//'.dat')
                                         do k=1,nz
                                            do j=1,ny
                                               do i=1,nx
                                                  write(589,*) i,j,k,res(i,j,k),u(i,j,k),rhs(i,j,k),u(i+1,j,k)+u(i-1,j,k)+u(i,j+1,k)+u(i,j-1,k)+u(i,j,k+1)+u(i,j,k-1)-6.d0*u(i,j,k),&
                                                       -h2i*(u(i+1,j,k)+u(i-1,j,k)+u(i,j+1,k)+u(i,j-1,k)+u(i,j,k+1)+u(i,j,k-1)-6.d0*u(i,j,k))+rhs(i,j,k),h2i
                                               end do
                                               !isw=3-isw
                                            end do
                                         end do
                                                           ...
                                                           do l = 1, 2
                                                              if(l.eq.1) then; mfx=nfy; mfy=nfz; mcx=ncy; mcy=ncz; end if
                                                                 if(l.eq.2) then; mfx=nfy; mfy=nfz; mcx=ncy; mcy=ncz; end if
                                                                    ...
                                                                    if(NRANK==40) then
                                                                       write (name1,'(i5.5)') count1
                                                                       open(151,file='zz'//name1//'151.dat')
                                                                       open(152,file='zz'//name1//'152.dat')
                                                                       open(153,file='zz'//name1//'153.dat')
                                                                       open(154,file='zz'//name1//'154.dat')
                                                                    endif
                                                                    ...
                                                                    do jc = 2,mcy-1; jf = 2*jc-1
                                                                       do ic = 2,mcx-1; if = 2*ic-1
                                                                          ...
                                                                          if(NRANK==40) then
                                                                             write(151,*) kf,kc,l, bphi2(pointb2(lc)+kc,l)
                                                                          endif
                                                                       end do
                                                                    end do
                                                                    ...
                                                                    do jc = 2,mcy-1; jf = 2*jc-1
                                                                       ...
                                                                       bphi2(pointb2(lc)+kc,l) = 5.d0*w*bphi2(pointb2(lc+1)+kf,l) + w*( bphi2(pointb2(lc+1)+kf-1   ,l)+ &
                                                                            bphi2(pointb2(lc+1)+kf-mfx-1,l)+bphi2(pointb2(lc+1)+kf+mfx+1,l) )
                                                                       if(NRANK==40) then
                                                                          write(152,*) bphi2(pointb2(lc)+kc,l)
                                                                       endif
                                                                    end do
                                                                    do ic = 2,mcx-1; if = 2*ic-1
                                                                       jc = 1; jf = 2*jc-1
                                                                       ...
                                                                       bphi2(pointb2(lc)+kc,l) = 5.d0*w*bphi2(pointb2(lc+1)+kf,l) + w*( bphi2(pointb2(lc+1)+kf-1   ,l)+bphi2(pointb2(lc+1)+kf+1   ,l)+ &
                                                                            bphi2(pointb2(lc+1)+kf-mfx-1,l)                                )
                                                                       if(NRANK==40) then
                                                                          write(153,*) bphi2(pointb2(lc)+kc,l)
                                                                       endif
                                                                    end do
                                                                    ...
                                                                    bphi2(pointb2(lc)+kc,l) = 6.d0*w*bphi2(pointb2(lc+1)+kf,l) + w*( bphi2(pointb2(lc+1)+kf-1 ,l)+ &
                                                                         bphi2(pointb2(lc+1)+kf-mfx-1,l)                                )
                                                                    if(NRANK==40) then
                                                                       write(154,*) bphi2(pointb2(lc)+kc,l)
                                                                    endif
                                                                     if(NRANK==40) then
                                                                        close(151)
                                                                        close(152)
                                                                 ...
                                                                 do k=1,n1; kk = n1*(k-1) + pointb1(NGcr)
                                                                    ...
                                                                    do k=0,nz; kk = (ny+1)*k + pointb2(NGcr)
                                                                       ...
                                                                       do k=1,n1; kk = n1*(k-1) + pointb1(NGcr)
                                                                          ...
                                                                          do lc=NGcr-1,1,-1
                                                                             if(NRANK==40) then
                                                                                write (name1,'(i5.5)') count2
                                                                                open(155,file='zz'//name1//'155.dat')
                                                                                open(156,file='zz'//name1//'156.dat')
                                                                                open(157,file='zz'//name1//'157.dat')
                                                                                open(158,file='zz'//name1//'158.dat')
                                                                             endif
                                                                             nf = nc
                                                                             nc = nc/2+1
                                                                             do l = 1, 2
                                                                                ...
                                                                                do jc = 2,nc-1; jf = 2*jc-1
                                                                                   do ic = 2,nc-1; if = 2*ic-1
                                                                                      ...
                                                                                      if(NRANK==40) then
                                                                                         write(155,*) bphi1(pointb1(lc)+kc,l)
                                                                                      endif
                                                                                   end do
                                                                                end do
                                                                                ...
                                                                                do jc = 2,nc-1; jf = 2*jc-1
                                                                                   ...
                                                                                   bphi1(pointb1(lc)+kc,l) = 5.d0*w*bphi1(pointb1(lc+1)+kf,l) + w*( bphi1(pointb1(lc+1)+kf-1 ,l)+ &
                                                                                        bphi1(pointb1(lc+1)+kf-nf,l)+bphi1(pointb1(lc+1)+kf+nf,l) )
                                                                                   if(NRANK==40) then
                                                                                      write(156,*) bphi1(pointb1(lc)+kc,l)
                                                                                   endif
                                                                                end do
                                                                                do ic = 2,nc-1; if = 2*ic-1
                                                                                   jc = 1; jf = 2*jc-1
                                                                                   ...
                                                                                   bphi1(pointb1(lc)+kc,l) = 5.d0*w*bphi1(pointb1(lc+1)+kf,l) + w*( bphi1(pointb1(lc+1)+kf-1 ,l)+bphi1(pointb1(lc+1)+kf+1 ,l)+ &
                                                                                        bphi1(pointb1(lc+1)+kf-nf,l)                            )
                                                                                   if(NRANK==40) then
                                                                                      write(157,*) bphi1(pointb1(lc)+kc,l)
                                                                                   endif
                                                                                end do
                                                                                ...
                                                                                if(NRANK==40) then
                                                                                   write(158,*) bphi1(pointb1(lc)+kc,l)
                                                                                endif
                                                                             end do
                                                                             if(NRANK==40) then
                                                                                close(155)
