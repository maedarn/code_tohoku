...
fL=func(Tp,Tp1,gamma,xmu,xLmbdch1,dt)
...
f=func(Tp,Tp2,gamma,xmu,xLmbdch2,dt)
...
do  i=1,maxit
   ...
   call chemreact(xnH,Tpsec,Tp_gr,Z_metal,&
           ytmp,dt,tchem1,xmu1,gamma1,xLmbdch1)
   f=func(Tp,Tpsec,gamma,xmu,xLmbdch1,dt)
...
double precision :: r_f(N_sp),r_f_fw(N_sp),r_f_bw(N_sp)
double precision :: dr_fdy(N_sp,N_sp),A(N_sp,N_sp)  
...
T_eV=8.61735d-5*T_K
phyc=2.d0*(2.d0*1.60219d-12*pi*xm_e/h_Pl**2)**1.5d0
chiH0=13.6d0
chiHe0=24.6d0
...
fH2=(zH0**2/zH2)*(1.60219d-12*pi*xm_p/h_Pl**2)**1.5d0&
