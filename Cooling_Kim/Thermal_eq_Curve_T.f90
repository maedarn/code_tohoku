  MODULE comvar
    ...
    character(44) :: svdir='/Users/maedarn/Dropbox/analysis/cooling/Kim/'
    ...
    double precision, parameter :: Zsolar=1.d-2
    ...
    MODULE INICN
    double precision, parameter :: Tmin=1.d-1,Tmax=1.d5,Tmp1p=1.d-3,Tmp2p=1.d2
    ...
    open(110,file=svdir//'Fcool_n1_z10m2.dat',access='stream',FORM='UNFORMATTED')!, position='append')
