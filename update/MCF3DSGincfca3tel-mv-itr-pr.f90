...
DOUBLE PRECISION, parameter :: cg=1.0d0,sourratio=0.5d0,adiff=0.25d0,rratio=0.2d0,tratio=0.5d0,rmove=35.d0!,adiff=0.375d0
double precision :: dx1,dy1,dz1,ddd,rrsph3,rrsph3x,rrsph3y,rrsph3z,vmove=0.02d0*cg/rmove,Tdiff=0.2d0
INTEGER, parameter :: mvstp=2
!integer ifevogrv,ifevogrv2
!character(25) :: dir='/work/maedarn/3DMHD/test/' !samplecnv2
character(42) :: dir='/work/maedarn/3DMHD/tel/tel-mesh128-mv-ex/'
character(7) :: svdir
END MODULE comvar
