...
CHARACTER(62) :: dir='/Users/maedarn/Dropbox/code/code/3DMHD-feedback/KIcool/DEN010/'
character(4) :: title
END MODULE comvar
...
dratio=12.92903d0/1.024d0*12.92903d0/16.412348980467353
...
Hini1=0.9219098d0*dratio; pini1=0.9503446d-2*dratio; H2ini1=0.9465513d-8*dratio; Heini1=0.9155226d-1*dratio
Hepini1=0.5655353d-3*dratio
Cini1=0.1565848d-8*dratio; COini1=0.2202631d-20*dratio; Cpini1=0.1433520d-3*dratio

Hini2=0.9219098d0*dratio; pini2=0.9503446d-2*dratio; H2ini2=0.9465513d-8*dratio; Heini2=0.9155226d-1*dratio
Hepini2=0.5655353d-3*dratio
Cini2=0.1565848d-8*dratio; COini2=0.2202631d-20*dratio; Cpini2=0.1433520d-3*dratio
...
!write(100,*) time,U(2,1)/1.27d0,U(2,5)*1.52d0/1.38d0 * 1.d2,U(2,6)
...
!************************
    call SOURCE(dt*0.5d0)
    time = time + dt
    !write(100,*) time,U(2,1)/1.27d0,U(1,5)*1.52d0/1.38d0 * 1.d2,U(1,7)
 end do
...
write(*,*)'1'
write(filenm,'("data/title",I3.3)') nunit
...
open(10,file=dir//filenm//'.dat')
   ...
   write(10,*) t(i),U(i,1),U(i,2),U(i,3),U(i,4),U(i,5),U(i,6),U(i,7),U(i,8), &
                ndH(i),ndp(i),ndH2(i),ndHe(i),ndHep(i),ndC(i),ndCO(i),ndCp(i)
close(10)
