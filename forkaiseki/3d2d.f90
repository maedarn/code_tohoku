...
!   corestart=core-corexy*midle
         ...
         do k = 1, Ncellz !*************************************************** +1 いる？ **********************************
            do j = 1, Ncelly
               read(150) (u(i,j,k,1),u(i,j,k,2),u(i,j,k,3),u(i,j,k,4),u(i,j,k,5), &
                    ...
                    u(i,j,k,13),u(i,j,k,14),u(i,j,k,15),u(i,j,k,16), &
                    u(i,j,k,17), i=1,Ncellx )
            end do
         end do
         close(150)
         do k = 1, Ncellz
            do j = 1, Ncelly
               ...
               v(i+IST*mesh,j+JST*mesh,k+KST*mesh,1)  = u(i,j,k,1)
   ...
   open(100,file='Dall'//time//'.dat')
   k = lengthz/2
!   do k=1,lengthz
      do j=1,lengthy
         do i=1,lengthx

            write(100,*) x(i),y(j),z(k),v(i,j,k,1)!,v(i,j,k,2),v(i,j,k,3),v(i,j,k,4),v(i,j,k,5),v(i,j,k,6),v(i,j,k,7),&
