...
character(32) :: dir='/work/maedarn/3DMHD/samplecnv18/' !samplecnv2
END MODULE comvar
...
!       if(abs((U(64,1,1,3)-U(64,2,1,3))/U(64,2,1,3)) > 1.d-2) then
!          write(*,*) NRANK,'err vy' ,U(64,0,1,3), U(64,1,1,3),U(64,2,1,3)
!       end if
!       if(abs((U(64,1,1,1)-U(64,2,1,1))/U(64,2,1,1)) > 1.d-2) then
!       if(abs((U(64,1,1,1)-U(64,2,1,1))) > 1.d1) then
       !            if(((U(64,1,1,1)-U(64,2,1,1))) < -1.d-2) then
       if(NRANK==139) then
          write(*,*) NRANK,'err rho' ,U(64,0,1,1), U(64,1,1,1),U(64,2,1,1)
       end if
       call SOURCE(0.5d0*dt)
!       if(abs((U(64,1,1,3)-U(64,2,1,3))/U(64,2,1,3)) > 1.d-2) then
!          write(*,*) NRANK,'err vy1' ,U(64,0,1,3), U(64,1,1,3),U(64,2,1,3)
!       end if
!       if(abs((U(64,1,1,1)-U(64,2,1,1))/U(64,2,1,1)) > 1.d-2) then
       !if(abs((U(64,1,1,1)-U(64,2,1,1))) > 1.d1) then
       !if(((U(64,1,1,1)-U(64,2,1,1))) < -1.d-2) then
       if(NRANK==139) then
        write(*,*) NRANK,'err rho1' ,U(64,0,1,1), U(64,1,1,1),U(64,2,1,1)
       end if
...
1000 continue
!    if(abs((U(64,1,1,3)-U(64,2,1,3))/U(64,2,1,3)) > 1.d-2) then
!          write(*,*) NRANK,'err vy2' ,U(64,0,1,3), U(64,1,1,3),U(64,2,1,3)
!       end if
    !if(abs((U(64,1,1,1)-U(64,2,1,1))) > 1.d1) then
    !if(((U(64,1,1,1)-U(64,2,1,1))) < -1.d-2) then
    if(NRANK==139) then
!    if(abs((U(64,1,1,1)-U(64,2,1,1))/U(64,2,1,1)) > 1.d-2) then
          write(*,*) NRANK,'err rho2' ,U(64,0,1,1), U(64,1,1,1),U(64,2,1,1)
       end if
    DEALLOCATE(Bcc)
...
!***** CT part *****
    ...
    call CC(4,dt)
!    if(abs((U(64,1,1,3)-U(64,2,1,3))/U(64,2,1,3)) > 1.d-2) then
!          write(*,*) NRANK,'err vy3' ,U(64,0,1,3), U(64,1,1,3),U(64,2,1,3)
!       end if
    !if(abs((U(64,1,1,1)-U(64,2,1,1))) > 1.d1) then
    !if(((U(64,1,1,1)-U(64,2,1,1))) < -1.d-2) then
    if(NRANK==139) then
!    if(abs((U(64,1,1,1)-U(64,2,1,1))/U(64,2,1,1)) > 1.d-2) then
          write(*,*) NRANK,'err rho3' ,U(64,0,1,1), U(64,1,1,1),U(64,2,1,1)
       end if
!if(NRANK==40) write(*,*) NRANK,in20,U(33,33,33,1),U(33,33,33,2),sngl(U(33,33,33,1)),'point6'
!***** Source parts 2*****
       call SOURCE(0.5d0*dt)
!       if(abs((U(64,1,1,3)-U(64,2,1,3))/U(64,2,1,3)) > 1.d-2) then
!          write(*,*) NRANK,'err vy4' ,U(64,0,1,3), U(64,1,1,3),U(64,2,1,3)
!       end if
!       if(abs((U(64,1,1,1)-U(64,2,1,1))/U(64,2,1,1)) > 1.d-2) then
       !if(((U(64,1,1,1)-U(64,2,1,1))) < -1.d-2) then
       if(NRANK==139) then
       !if(abs((U(64,1,1,1)-U(64,2,1,1))) > 1.d1) then
       write(*,*) NRANK,'err rho4' ,U(64,0,1,1), U(64,1,1,1),U(64,2,1,1)
       end if
    if(ifgrv.eq.2) then; call GRAVTY(dt,2); call GRAVTY(dt,3); end if
       ...
       !       if(abs((U(64,1,1,3)-U(64,2,1,3))/U(64,2,1,3)) > 1.d-2) then
       !          write(*,*) NRANK,'err vy5' ,U(64,0,1,3), U(64,1,1,3),U(64,2,1,3)
       !       end if
       !       if(abs((U(64,1,1,1)-U(64,2,1,1))/U(64,2,1,1)) > 1.d-2) then
       !if(abs((U(64,1,1,1)-U(64,2,1,1))) > 1.d1) then
       !if(((U(64,1,1,1)-U(64,2,1,1))) < -1.d-2) then
       if(NRANK==139) then
       write(*,*) NRANK,'err rho5' ,U(64,0,1,1), U(64,1,1,1),U(64,2,1,1)
       end if
    call DISSIP()
    time = time + dt
  end do
...
!********************************  BC for the rightsides of domains  ****
  DO K = 1, N_MPI(20)
    ...
    IF((BCx2.eq.4).and.(IST.eq.NSPLTx-1)) THEN
      ...
      if(N_MPI(K).eq.6) then
      DO KZ = -1, Ncellz+2; DO JY = -1, Ncelly+2; DO IX = Ncellx+1, Ncellx+N_ol !!! divfree
        U(IX,JY,KZ,6) = U(Ncellx,JY,KZ,6)
      END DO;END DO;END DO; goto 2
      end if
      !if(N_MPI(K).eq.6) then
...
do k = -1,Ncellz+2
   do j = -1,Ncelly+2
      ...
      do i = 1,2
        write(17) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
     ...
     do i = Ncellx-2,Ncellx-1
        write(12) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do i = Ncellx+1,Ncellx+2
        write(22) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do i = -1,0
        write(27) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
...
do i = -1,Ncellx+2
   do k = -1,Ncellz+2
      ...
      do j = 1,2
        write(14) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do j = Ncelly-2,Ncelly-1
        write(13) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do j = Ncelly+1,Ncelly+2
        write(23) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do j = -1,0
        write(24) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
...
do j = -1,Ncelly+2
   do i = -1,Ncellx+2
      ...
      do k = 1,2
        write(16) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do k = Ncellz-2,Ncellz-1
        write(15) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do k = Ncellz+1,Ncellz+2
        write(25) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
     ...
     do k = -1,0
        write(26) U(i,j,k,1),U(i,j,k,2),U(i,j,k,3),U(i,j,k,4),U(i,j,k,5), &
        U(i,j,k,6),U(i,j,k,7),U(i,j,k,8), &
        ndH(i,j,k),ndp(i,j,k),ndH2(i,j,k),ndHe(i,j,k), &
        ndHep(i,j,k),ndC(i,j,k),ndCO(i,j,k),ndCp(i,j,k), &
        Phi(i,j,k)
...
write(sav,'(i5.5)') inp
write(frank,'(i3.3)') NRANK
open(12,file='inBC_MPI_OTxr'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(17,file='inBC_MPI_OTxl'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(13,file='inBC_MPI_OTyr'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(14,file='inBC_MPI_OTyl'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(15,file='inBC_MPI_OTzr'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(16,file='inBC_MPI_OTzl'//frank//sav//'.DAT',FORM='UNFORMATTED')

open(22,file='bcBC_MPI_OTxr'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(27,file='bcBC_MPI_OTxl'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(23,file='bcBC_MPI_OTyr'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(24,file='bcBC_MPI_OTyl'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(25,file='bcBC_MPI_OTzr'//frank//sav//'.DAT',FORM='UNFORMATTED')
open(26,file='bcBC_MPI_OTzl'//frank//sav//'.DAT',FORM='UNFORMATTED')
