...
double precision :: Phigrdpr(-1:ndx,-1:ndy,-1:ndz,1:1),Phipr(-1:ndx,-1:ndy,-1:ndz,1:1)
...
!   call muslcslv1D(Phigrdwv(-1,-1,-1,8),dt*0.5d0,1)
   ...
   call BCgrv(100,1,8)
   Phipr(:,:,:,1)=Phiwv(:,:,:,1)
   Phigrdpr(:,:,:,1)=Phigrdwv(:,:,:,1)
   do k=1,ndz-2
     do j=1,ndy-2
       do i=1,ndx-2

Phiwv(i,j,k,1)=Phipr(i,j,k,1)*0.5d0*(1.d0+dexp(-0.5d0/Tdiff * dt)) &
+Phigrdpr(i,j,k,1)*0.5d0*(1.d0-dexp(-0.5d0/Tdiff * dt)) &
+(0.5d0*dt-0.5d0*Tdiff+0.5d0*Tdiff*dexp(-0.5d0/Tdiff * dt))* &
(-cg*cg*2.d0*Tdiff*G4pi*rho(i,j,k))

Phigrdwv(i,j,k,1)=Phipr(i,j,k,1)*0.5d0*(1.d0-dexp(-0.5d0/Tdiff * dt)) &
+Phigrdpr(i,j,k,1)*0.5d0*(1.d0+dexp(-0.5d0/Tdiff * dt)) &
+(0.5d0*dt+0.5d0*Tdiff-0.5d0*Tdiff*dexp(-0.5d0/Tdiff * dt))* &
(-cg*cg*2.d0*Tdiff*G4pi*rho(i,j,k))
       enddo
...
grdxy1=adiff*Phipr(i+1,j+1,k,1)+adiff*Phipr(i-1,j-1,k,1)+(adiff-0.5d0)*Phipr(i+1,j-1,k,1)+(adiff-0.5d0)*Phipr(i-1,j+1,k,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j+1,k,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i-1,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j-1,k,1)
grdyz1=adiff*Phipr(i,j+1,k+1,1)+adiff*Phipr(i,j-1,k-1,1)+(adiff-0.5d0)*Phipr(i,j+1,k-1,1)+(adiff-0.5d0)*Phipr(i,j-1,k+1,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j+1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j,k+1,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i,j-1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j,k-1,1)
grdzx1=adiff*Phipr(i+1,j,k+1,1)+adiff*Phipr(i-1,j,k-1,1)+(adiff-0.5d0)*Phipr(i-1,j,k+1,1)+(adiff-0.5d0)*Phipr(i+1,j,k-1,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j,k+1,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j,k,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i,j,k-1,1)+(-2.d0*adiff+0.5d0)*Phipr(i-1,j,k,1)

grdxy1zp=adiff*Phipr(i+1,j+1,k+1,1)+adiff*Phipr(i-1,j-1,k+1,1)+(adiff-0.5d0)*Phipr(i+1,j-1,k+1,1)+(adiff-0.5d0)*Phipr(i-1,j+1,k+1,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j,k+1,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j,k+1,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j+1,k+1,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i-1,j,k+1,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j-1,k+1,1)
grdxy1zm=adiff*Phipr(i+1,j+1,k-1,1)+adiff*Phipr(i-1,j-1,k-1,1)+(adiff-0.5d0)*Phipr(i+1,j-1,k-1,1)+(adiff-0.5d0)*Phipr(i-1,j+1,k-1,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j,k-1,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j,k-1,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j+1,k-1,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i-1,j,k-1,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j-1,k-1,1)
grdxy1mn=(grdxy1+grdxy1zp+grdxy1zm)/3.d0

grdyz1xp=adiff*Phipr(i+1,j+1,k+1,1)+adiff*Phipr(i+1,j-1,k-1,1)+(adiff-0.5d0)*Phipr(i+1,j+1,k-1,1)+(adiff-0.5d0)*Phipr(i+1,j-1,k+1,1) &
+(4.d0*adiff-1.d0)*Phipr(i+1,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j+1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j,k+1,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i+1,j-1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j,k-1,1)
grdyz1xm=adiff*Phipr(i-1,j+1,k+1,1)+adiff*Phipr(i-1,j-1,k-1,1)+(adiff-0.5d0)*Phipr(i-1,j+1,k-1,1)+(adiff-0.5d0)*Phipr(i-1,j-1,k+1,1) &
+(4.d0*adiff-1.d0)*Phipr(i-1,j,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i-1,j+1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i-1,j,k+1,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i-1,j-1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i-1,j,k-1,1)
grdyz1mn=(grdyz1+grdyz1xp+grdyz1xm)/3.d0

grdzx1yp=adiff*Phipr(i+1,j+1,k+1,1)+adiff*Phipr(i-1,j+1,k-1,1)+(adiff-0.5d0)*Phipr(i-1,j+1,k+1,1)+(adiff-0.5d0)*Phipr(i+1,j+1,k-1,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j+1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j+1,k+1,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j+1,k,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i,j+1,k-1,1)+(-2.d0*adiff+0.5d0)*Phipr(i-1,j+1,k,1)
grdzx1ym=adiff*Phipr(i+1,j-1,k+1,1)+adiff*Phipr(i-1,j-1,k-1,1)+(adiff-0.5d0)*Phipr(i-1,j-1,k+1,1)+(adiff-0.5d0)*Phipr(i+1,j-1,k-1,1) &
+(4.d0*adiff-1.d0)*Phipr(i,j-1,k,1)+(-2.d0*adiff+0.5d0)*Phipr(i,j-1,k+1,1)+(-2.d0*adiff+0.5d0)*Phipr(i+1,j-1,k,1)+&
(-2.d0*adiff+0.5d0)*Phipr(i,j-1,k-1,1)+(-2.d0*adiff+0.5d0)*Phipr(i-1,j-1,k,1)
grdzx1mn=(grdzx1+grdzx1yp+grdzx1ym)/3.d0

Phigrdwv(i,j,k,1)=Phigrdpr(i,j,k,1)+ dt* &
(-2.d0*2.d0*Tdiff*cg*cg*grdxy1mn/dx1/dy1 &
 -2.d0*2.d0*Tdiff*cg*cg*grdyz1mn/dy1/dz1 &
 -2.d0*2.d0*Tdiff*cg*cg*grdzx1mn/dz1/dx1 )
       enddo
     enddo
   enddo
   !iwx=1;iwy=1;iwz=1
