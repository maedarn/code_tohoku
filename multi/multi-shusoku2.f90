...
subroutine save(u,Px,Py,n,tsave)
  integer n,tsave
  double precision  u(n,n)
  ...
  character(4) :: filenm='ml-1'
  character(2) sv
  write(sv,'(I2.2)') tsave
100 format(E19.10e3,E19.10e3,E19.10e3)
  open(10,file=dir//filenm//sv//'.dat')
  do i = 1,n
     do j=1,n
  ...
  ! write(*,*) '--------------sav----------------'
  write(*,*) 'gosa=', -gosa(tsave)+gosa(tsave-1)
  tsave=tsave+1
end subroutine save
