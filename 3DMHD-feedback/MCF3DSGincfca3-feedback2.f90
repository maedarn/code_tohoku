...
write(*,*)'BE-pre'
  ...
  do k = -1, Ncellz+2; do j = -1, Ncelly+2; do i = -1, Ncellx+2
   ...
   U(i,j,k,3) = 0.0d0
   U(i,j,k,4) = 0.0d0
   U(i,j,k,5) = rhosphBE(isph)*cs0*cs0
   U(i,j,k,6) = binitx1
   U(i,j,k,7) = binitx1
   U(i,j,k,8) = binitx1
   ndH(i,j,k)   = 0.0d0
...
if(NRANK==40) write(*,*) NRANK,U(1,1,1,1),U(1,1,1,2),U(1,1,1,3),U(1,1,1,4),U(1,1,1,5),U(1,1,1,6),U(1,1,1,7),U(1,1,1,8),iwx,iwy,iwz,'pointMHD11'
if(NRANK==40) write(*,*) NRANK,U(33,33,33,1),U(33,33,33,2),U(33,33,33,3),U(33,33,33,4),U(33,33,33,5),U(33,33,33,6),U(33,33,33,7),U(33,33,33,8),iwx,iwy,iwz,'pointMHD1'
call RHS(dt,dxelr)
if(NRANK==40) write(*,*) NRANK,U(1,1,1,1),U(1,1,1,2),U(1,1,1,3),U(1,1,1,4),U(1,1,1,5),U(1,1,1,6),U(1,1,1,7),U(1,1,1,8),iwx,iwy,iwz,'pointMHD21'
if(NRANK==40) write(*,*) NRANK,U(33,33,33,1),U(33,33,33,2),U(33,33,33,3),U(33,33,33,4),U(33,33,33,5),U(33,33,33,6),U(33,33,33,7),U(33,33,33,8),iwx,iwy,iwz,'pointMHD2'
call MOC(dt,xelr)
if(NRANK==40) write(*,*) NRANK,U(1,1,1,1),U(1,1,1,2),U(1,1,1,3),U(1,1,1,4),U(1,1,1,5),U(1,1,1,6),U(1,1,1,7),U(1,1,1,8),iwx,iwy,iwz,'pointMHD31'
if(NRANK==40) write(*,*) NRANK,U(33,33,33,1),U(33,33,33,2),U(33,33,33,3),U(33,33,33,4),U(33,33,33,5),U(33,33,33,6),U(33,33,33,7),U(33,33,33,8),iwx,iwy,iwz,'pointMHD3'
...
if(NRANK==40) write(*,*) NRANK,U(33,33,33,1),U(33,33,33,2),U(33,33,33,3),U(33,33,33,4),U(33,33,33,5),U(33,33,33,6),U(33,33,33,7),U(33,33,33,8),'pointRHS1'
if(NRANK==40) write(*,*) NRANK,U(1,1,1,1),U(1,1,1,2),U(1,1,1,3),U(1,1,1,4),U(1,1,1,5),U(1,1,1,6),U(1,1,1,7),U(1,1,1,8),'pointRHS11'
...
if(NRANK==40) write(*,*) NRANK,U(33,33,33,1),U(33,33,33,2),U(33,33,33,3),U(33,33,33,4),U(33,33,33,5),U(33,33,33,6),U(33,33,33,7),U(33,33,33,8),'pointRHS2'
if(NRANK==40) write(*,*) NRANK,U(1,1,1,1),U(1,1,1,2),U(1,1,1,3),U(1,1,1,4),U(1,1,1,5),U(1,1,1,6),U(1,1,1,7),U(1,1,1,8),'pointRHS21'
