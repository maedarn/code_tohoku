...
program main
  implicit none
  INTEGER :: n=513,tsave=0,itr,itr2,itr3,itr4
...
subroutine save(u,Px,Py,n,tsave,itr2,itr3,itr4)
  ...
  CHARACTER(39) :: dir='/Users/maeda/Desktop/code/multi-susoku/'
  character(4) :: filenm='ml-2',chr
  character(4) :: filenm2='gml2'
  character(2) sv
...
100 format(E19.10e3,E19.10e3,E19.10e3)
 ...
 !       write(10,100) Px(i) , Py(j) , u(i,j)
  ...
  write(11,100)  gosa(tsave)
  !write(11,100)  -gosa(tsave)+gosa(tsave-1) , gosa(tsave)
  tsave=tsave+1
end subroutine save
