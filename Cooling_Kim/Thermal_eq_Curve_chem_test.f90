...
use chmvar
!implicit none
integer, parameter :: ix = 2 !,itrcool=1000
...
DOUBLE PRECISION :: tint,dt,Tmpmid,Tmp2,CooL1,CooL2,CooLmid,nechl,nechh,nechmd,neoldl,neoldh,neoldmd,dinit1,Rhopre
...
!write(*,*)'SHIELD',T,ndp,ndH,ndH2,ndHm,ndHe,ndHep,ndC,ndCp,ndCO,nde,ndtot,Ntot,NH2,NnC,NCO,tCII,dt
