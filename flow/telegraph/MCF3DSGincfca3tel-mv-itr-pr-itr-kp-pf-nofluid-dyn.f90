...
!if(NPE.eq.24000)then; NSPLTx =40; NSPLTy =20; NSPLTz =30; end if
if(NPE.eq.24000)then; NSPLTx =40; NSPLTy =30; NSPLTz =20; end if
...
SUBROUTINE SAVEU(nunit,dt,stb,st,t)
USE comvar
USE mpivar
USE chmvar
USE slfgrv
...
double precision  :: rtTx,rtTy,rtTz,tcd,CooL!,mmean
...
double precision :: fesC1,fesC2,tO1,tO2,fesO1,fesO2!,tC1,tC2
