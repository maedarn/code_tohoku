...
if(mode.eq.1) then
  call fapp_start("loopG1",1,0) 
  call pinter(Nmem1,Nmem2,Ncellx,Ncelly,Ncellz)
  call fapp_stop("loopG1",1,0) 
end if

if(mode.eq.2) then

  call fapp_start("loopG2",1,0) 
   ...
   call fapp_stop("loopG2",1,0) 

   call fapp_start("loopG3",1,0) 

   call PB()
   call fapp_stop("loopG3",1,0) 

   call fapp_start("loopG4",1,0) 
   call mglin(Nmem1,Nmem2,2,5,5)
   call fapp_stop("loopG4",1,0) 
...
u(2,1,1) = 0.025d0*h*h*(-8.d0*rhs(2,1,1)-2.d0*rhs(2,1,2)-2.d0*rhs(2,1,3)-2.d0*rhs(2,2,1)&
-rhs(2,2,2)-rhs(2,2,3)-2.d0*rhs(2,3,1)-rhs(2,3,2)-rhs(2,3,3))
u(2,2,1) = 0.025d0*h*h*(-2.d0*rhs(2,1,1)-rhs(2,1,2)-rhs(2,1,3)-8.d0*rhs(2,2,1)&
-2.d0*rhs(2,2,2)-2.d0*rhs(2,2,3)-2.d0*rhs(2,3,1)-rhs(2,3,2)-rhs(2,3,3))
u(2,3,1) = 0.025d0*h*h*(-2.d0*rhs(2,1,1)-rhs(2,1,2)-rhs(2,1,3)-2.d0*rhs(2,2,1)&
-rhs(2,2,2)-rhs(2,2,3)-8.d0*rhs(2,3,1)-2.d0*rhs(2,3,2)-2.d0*rhs(2,3,3))
u(2,1,2) = 0.025d0*h*h*(-2.d0*rhs(2,1,1)-8.d0*rhs(2,1,2)-2.d0*rhs(2,1,3)-rhs(2,2,1)&
-2.d0*rhs(2,2,2)-rhs(2,2,3)-rhs(2,3,1)-2.d0*rhs(2,3,2)-rhs(2,3,3))
u(2,2,2) = 0.025d0*h*h*(-rhs(2,1,1)-2.d0*rhs(2,1,2)-rhs(2,1,3)-2.d0*rhs(2,2,1)&
-8.d0*rhs(2,2,2)-2.d0*rhs(2,2,3)-rhs(2,3,1)-2.d0*rhs(2,3,2)-rhs(2,3,3))
u(2,3,2) = 0.025d0*h*h*(-rhs(2,1,1)-2.d0*rhs(2,1,2)-rhs(2,1,3)-rhs(2,2,1)-2.d0*rhs(2,2,2)&
-rhs(2,2,3)-2.d0*rhs(2,3,1)-8.d0*rhs(2,3,2)-2.d0*rhs(2,3,3))
u(2,1,3) = 0.025d0*h*h*(-2.d0*rhs(2,1,1)-2.d0*rhs(2,1,2)-8.d0*rhs(2,1,3)-rhs(2,2,1)&
-rhs(2,2,2)-2.d0*rhs(2,2,3)-rhs(2,3,1)-rhs(2,3,2)-2.d0*rhs(2,3,3))
u(2,2,3) = 0.025d0*h*h*(-rhs(2,1,1)-rhs(2,1,2)-2.d0*rhs(2,1,3)-2.d0*rhs(2,2,1)-2.d0*rhs(2,2,2)&
-8.d0*rhs(2,2,3)-rhs(2,3,1)-rhs(2,3,2)-2.d0*rhs(2,3,3))
u(2,3,3) = 0.025d0*h*h*(-rhs(2,1,1)-rhs(2,1,2)-2.d0*rhs(2,1,3)-rhs(2,2,1)-rhs(2,2,2)&
-2.d0*rhs(2,2,3)-2.d0*rhs(2,3,1)-2.d0*rhs(2,3,2)-8.d0*rhs(2,3,3))
...
u(2,1,1) = 0.025d0* (8.d0*u(1,1,1) + 2.d0*u(1,1,2) + 2.d0*u(1,1,3) + 2.d0*u(1,2,1)&
+ u(1,2,2) + u(1,2,3) + 2.d0*u(1,3,1) + &
u(1,3,2) + u(1,3,3) + 8.d0*u(3,1,1) + 2.d0*u(3,1,2) + 2.d0*u(3,1,3) + 2.d0*u(3,2,1)&
+ u(3,2,2) + u(3,2,3) + 2.d0*u(3,3,1) + u(3,3,2) + u(3,3,3) &
 - 8.d0*h*h*rhs(2,1,1) - 2.d0*h*h*rhs(2,1,2) - 2.d0*h*h*rhs(2,1,3) - 2.d0*h*h*rhs(2,2,1)&
- h*h*rhs(2,2,2) - h*h*rhs(2,2,3) - &
2.d0*h*h*rhs(2,3,1) - h*h*rhs(2,3,2) - h*h*rhs(2,3,3))
u(2,2,1) = 0.025d0* (2.d0*u(1,1,1) + u(1,1,2) + u(1,1,3) + 8.d0*u(1,2,1) + 2.d0*u(1,2,2)&
+ 2.d0*u(1,2,3) + 2.d0*u(1,3,1) + &
u(1,3,2) + u(1,3,3) + 2.d0*u(3,1,1) + u(3,1,2) + u(3,1,3) + 8.d0*u(3,2,1) + 2.d0*u(3,2,2)&
+ 2.d0*u(3,2,3) + 2.d0*u(3,3,1) + u(3,3,2) + u(3,3,3) &
- 2.d0*h*h*rhs(2,1,1) - h*h*rhs(2,1,2) - h*h*rhs(2,1,3) - 8.d0*h*h*rhs(2,2,1)&
- 2.d0*h*h*rhs(2,2,2) - 2.d0*h*h*rhs(2,2,3) - &
2.d0*h*h*rhs(2,3,1) - h*h*rhs(2,3,2) - h*h*rhs(2,3,3))
u(2,3,1) = 0.025d0* (2.d0*u(1,1,1) + u(1,1,2) + u(1,1,3) + 2.d0*u(1,2,1)&
+ u(1,2,2) + u(1,2,3) + 8.d0*u(1,3,1) + 2.d0*u(1,3,2) + &
2.d0*u(1,3,3) + 2.d0*u(3,1,1) + u(3,1,2) + u(3,1,3) + 2.d0*u(3,2,1) + u(3,2,2)&
+ u(3,2,3) + 8.d0*u(3,3,1) + 2.d0*u(3,3,2) + 2.d0*u(3,3,3) &
- 2.d0*h*h*rhs(2,1,1) - h*h*rhs(2,1,2) - h*h*rhs(2,1,3) - 2.d0*h*h*rhs(2,2,1)&
- h*h*rhs(2,2,2) - h*h*rhs(2,2,3) - &
8.d0*h*h*rhs(2,3,1) - 2.d0*h*h*rhs(2,3,2) - 2.d0*h*h*rhs(2,3,3))
u(2,1,2) = 0.025d0* (2.d0*u(1,1,1) + 8.d0*u(1,1,2) + 2.d0*u(1,1,3) + u(1,2,1)&
+ 2.d0*u(1,2,2) + u(1,2,3) + u(1,3,1) + 2.d0*u(1,3,2) + &
u(1,3,3) + 2.d0*u(3,1,1) + 8.d0*u(3,1,2) + 2.d0*u(3,1,3) + u(3,2,1) + 2.d0*u(3,2,2)&
+ u(3,2,3) + u(3,3,1) + 2.d0*u(3,3,2) + u(3,3,3) &
- 2.d0*h*h*rhs(2,1,1) - 8.d0*h*h*rhs(2,1,2) - 2.d0*h*h*rhs(2,1,3) - h*h*rhs(2,2,1)&
- 2.d0*h*h*rhs(2,2,2) - h*h*rhs(2,2,3) - &
h*h*rhs(2,3,1) - 2.d0*h*h*rhs(2,3,2) - h*h*rhs(2,3,3))
u(2,2,2) = 0.025d0* ( u(1,1,1) + 2.d0*u(1,1,2) + u(1,1,3) + 2.d0*u(1,2,1)&
+ 8.d0*u(1,2,2) + 2.d0*u(1,2,3) + u(1,3,1) + 2.d0*u(1,3,2) + &
u(1,3,3) + u(3,1,1) + 2.d0*u(3,1,2) + u(3,1,3) + 2.d0*u(3,2,1) + 8.d0*u(3,2,2)&
+ 2.d0*u(3,2,3) + u(3,3,1) + 2.d0*u(3,3,2) + u(3,3,3) &
- h*h*rhs(2,1,1) - 2.d0*h*h*rhs(2,1,2) - h*h*rhs(2,1,3) - 2.d0*h*h*rhs(2,2,1)&
- 8.d0*h*h*rhs(2,2,2) - 2.d0*h*h*rhs(2,2,3) - &
h*h*rhs(2,3,1) - 2.d0*h*h*rhs(2,3,2) - h*h*rhs(2,3,3))
u(2,3,2) = 0.025d0* ( u(1,1,1) + 2.d0*u(1,1,2) + u(1,1,3) + u(1,2,1) + 2.d0*u(1,2,2)&
+ u(1,2,3) + 2.d0*u(1,3,1) + 8.d0*u(1,3,2) + &
2.d0*u(1,3,3) + u(3,1,1) + 2.d0*u(3,1,2) + u(3,1,3) + u(3,2,1) + 2.d0*u(3,2,2)&
+ u(3,2,3) + 2.d0*u(3,3,1) + 8.d0*u(3,3,2) + 2.d0*u(3,3,3) &
- h*h*rhs(2,1,1) - 2.d0*h*h*rhs(2,1,2) - h*h*rhs(2,1,3) - h*h*rhs(2,2,1)&
- 2.d0*h*h*rhs(2,2,2) - h*h*rhs(2,2,3) - &
2.d0*h*h*rhs(2,3,1) - 8.d0*h*h*rhs(2,3,2) - 2.d0*h*h*rhs(2,3,3))
u(2,1,3) = 0.025d0* (2.d0*u(1,1,1) + 2.d0*u(1,1,2) + 8.d0*u(1,1,3) + u(1,2,1)&
+ u(1,2,2) + 2.d0*u(1,2,3) + u(1,3,1) + u(1,3,2) + &
2.d0*u(1,3,3) + 2.d0*u(3,1,1) + 2.d0*u(3,1,2) + 8.d0*u(3,1,3) + u(3,2,1)&
+ u(3,2,2) + 2.d0*u(3,2,3) + u(3,3,1) + u(3,3,2) + 2.d0*u(3,3,3) &
- 2.d0*h*h*rhs(2,1,1) - 2.d0*h*h*rhs(2,1,2) - 8.d0*h*h*rhs(2,1,3) - h*h*rhs(2,2,1)&
- h*h*rhs(2,2,2) - 2.d0*h*h*rhs(2,2,3) - &
h*h*rhs(2,3,1) - h*h*rhs(2,3,2) - 2.d0*h*h*rhs(2,3,3))
u(2,2,3) = 0.025d0* ( u(1,1,1) + u(1,1,2) + 2.d0*u(1,1,3) + 2.d0*u(1,2,1)&
+ 2.d0*u(1,2,2) + 8.d0*u(1,2,3) + u(1,3,1) + u(1,3,2) + &
2.d0*u(1,3,3) + u(3,1,1) + u(3,1,2) + 2.d0*u(3,1,3) + 2.d0*u(3,2,1) + 2.d0*u(3,2,2)&
+ 8.d0*u(3,2,3) + u(3,3,1) + u(3,3,2) + 2.d0*u(3,3,3) &
- h*h*rhs(2,1,1) - h*h*rhs(2,1,2) - 2.d0*h*h*rhs(2,1,3) - 2.d0*h*h*rhs(2,2,1)&
- 2.d0*h*h*rhs(2,2,2) - 8.d0*h*h*rhs(2,2,3) - &
h*h*rhs(2,3,1) - h*h*rhs(2,3,2) - 2.d0*h*h*rhs(2,3,3))
u(2,3,3) = 0.025d0* ( u(1,1,1) + u(1,1,2) + 2.d0*u(1,1,3) + u(1,2,1) + u(1,2,2)&
+ 2.d0*u(1,2,3) + 2.d0*u(1,3,1) + 2.d0*u(1,3,2) + &
8.d0*u(1,3,3) + u(3,1,1) + u(3,1,2) + 2.d0*u(3,1,3) + u(3,2,1) + u(3,2,2)&
+ 2.d0*u(3,2,3) + 2.d0*u(3,3,1) + 2.d0*u(3,3,2) + 8.d0*u(3,3,3) &
- h*h*rhs(2,1,1) - h*h*rhs(2,1,2) - 2.d0*h*h*rhs(2,1,3) - h*h*rhs(2,2,1)&
- h*h*rhs(2,2,2) - 2.d0*h*h*rhs(2,2,3) - &
...
double precision u(0:nx,0:ny,0:nz),rhs(0:nx,0:ny,0:nz),upre(0:nx,0:ny,0:nz)
double precision h,h2
integer :: check,check2,ctime=0,ctime2=0,check3=0
integer mode1,mode2,mode,li,lj,lk !,modex,modey,modez

mode1 = int(1/mode)
mode2 = int(0.5d0+dsign(0.5d0,dble(mode)-1.5d0)) 


call fapp_start("loopRL1",1,0) 
...
!end if
!CALL MPI_BARRIER(MPI_COMM_WORLD,IERR)
li = int(0.5d0-dsign(0.5d0,dble(IST)-0.5d0)) 
lj = int(0.5d0-dsign(0.5d0,dble(JST)-0.5d0)) 
lk = int(0.5d0-dsign(0.5d0,dble(KST)-0.5d0)) 
...
double precision h,h2
integer mode1,mode2,mode

mode1 = int(1/mode)
mode2 = int(0.5d0+dsign(0.5d0,dble(mode)-1.5d0)) 

call fapp_start("loopRL2",1,0) 
...
do i=1,Ncellx
  data(jy,kz,i) = U(i,j,k,1)+Rhost(i,j,k)!*G4pi
end do;end do;end do
...
do lc=NGL-1,NGcr-1,-1
  ...
  do ic = 2,mcx-1; if = 2*ic-1
    kf = if+(mcx*2)*jf
    kc = ic+(mcx+1)*jc
    bphi2(pointb2(lc)+kc,l) = 4.d0*w*bphi2(pointb2(lc+1)+kf,l) + &
w*( bphi2(pointb2(lc+1)+kf-1    ,l)+bphi2(pointb2(lc+1)+kf+1    ,l)+ &
 bphi2(pointb2(lc+1)+kf-mfx-1,l)+bphi2(pointb2(lc+1)+kf+mfx+1,l) )
  ...
  do jc = 2,mcy-1; jf = 2*jc-1
    ...
    kf = if+(mcx*2)*jf
    kc = ic+(mcx+1)*jc
    bphi2(pointb2(lc)+kc,l) = 5.d0*w*bphi2(pointb2(lc+1)+kf,l) +&
w*(                                bphi2(pointb2(lc+1)+kf+1   ,l)+ &
 bphi2(pointb2(lc+1)+kf-mfx-1,l)+bphi2(pointb2(lc+1)+kf+mfx+1,l) )
    ic = mcx; if = 2*ic-1
    kf = if+(mcx*2)*jf
    kc = ic+(mcx+1)*jc
...
w*( bphi2(pointb2(lc+1)+kf-1   ,l)+bphi2(pointb2(lc+1)+kf+1   ,l)+ &
  bphi2(pointb2(lc+1)+kf-mfx-1,l)                                )
    ...
    kf = if+(mcx*2)*jf
    kc = ic+(mcx+1)*jc
    bphi2(pointb2(lc)+kc,l) = 6.d0*w*bphi2(pointb2(lc+1)+kf,l) +&
w*(                                bphi2(pointb2(lc+1)+kf+1   ,l)+ &
  bphi2(pointb2(lc+1)+kf+mfx+1,l) )
    jc = 1 ; jf = 2*jc-1
    ic = mcx; if = 2*ic-1
