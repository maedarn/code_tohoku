...
write_hdf5_data()
{
  ...
  for(time=0;time<last;time++){
    ...
    //char s1[6] = {'\0'};
    //sprintf(s1, "%6d", time);
    sprintf(filename, "/Users/maeda/Desktop/kaiseki/testcode8/INIPHI2%06d.dat", time);
    sprintf(filename1, "/Users/maeda/Desktop/kaiseki/testcode8/INIPHI2%06d.h5", time);
