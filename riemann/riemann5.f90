...
program main
  ...
  real(8) dl , ul , pl , cl , dr , ur , pr , cr, d0 , u0 , p0, M0, r1, r2
  ...
  integer dt , tstep
  real(8) a
  character(41) :: dir='/Users/maedarn/Dropbox/code/code/riemann/'
...
dr = 5.465d-3
p0 = 1.01325d0 * 1.d6
u0 = dsqrt(gamma*p0/d0)*1.5d0
M0 =1.5d0

r1=(gamma+1.d0)*M0**2/((gamma-1.d0)*M0**2+2.d0)
r2=(2.d0*gamma*M0**2-(gamma-1.d0))/(gamma+1.d0)
write(*,*) 'r',r1,r2
...
ul=u0/r1+u0
  ...
  write (filename, '("ariemanndata", i4.4, ".dat")') 0
  open(17, file=dir//filename,access='stream',FORM='FORMATTED')
  ...
  do dt = 1 , tstep
     ...
     write (filename, '("ariemanndata", i4.4, ".dat")') dt
     open(17, file=dir//filename,access='stream',FORM='FORMATTED')
