program computeraw
 ...
 integer :: i,j,k,kz=1,initime, Ncellx, Ncelly, Ncellz,usecore,datanamem,cnt10
 character(50) filename,data
 character(3) NPE,cntc!,time
 character(6) time
...
!      write(time,'(I6.6)') times
   ...
   write(*,*) cntc
      open(100,file='/Users/maeda/Desktop/kaiseki/mvhdf/Allnew'//cntc//'.DAT',FORM='UNFORMATTED')
      do k=1,lengthz
         do j=1,lengthy
            do i=1,lengthx
      ...
      close(100)
      open(110,file='/Users/maeda/Desktop/kaiseki/mvhdf/f'//cntc//'.dat',FORM='FORMATTED')
      do k=1,lengthz
         do j=1,lengthy
            do i=1,lengthx
