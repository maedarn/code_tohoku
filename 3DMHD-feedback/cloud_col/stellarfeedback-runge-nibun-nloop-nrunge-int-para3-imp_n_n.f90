...
DOUBLE PRECISION :: nlpnm2,nlpnm5,nlpnm8,nlpnm9,nlpnm10,nlpnm11,nwnid2,nlpnm21,nlpnm22,nlpnm23,nlpnm25,nlpnm26,nlpnm27,nlpnm88,nlpnm888,nlpnm99,nlpmassive
...
U(i,j,k,5)=(3.d0*1.d4/T0)*kb*(ndp(i,j,k)+ndH(i,j,k)+ndH2(i,j,k)+ndHe(i,j,k)+ndHep(i,j,k))*nlpnm11*nlpnm888+U(i,j,k,5)*(1.d0-nlpnm11*nlpnm888)
end do; end do; end do
...
call runge(Ustar(1,nstloop),Ustar(2,nstloop),Ustar(3,nstloop),Ustar(4,nstloop),dt,nstloop,rsixc,rsjyc,rskzc,1,(Ustar(7,nstloop)+Ustar(19,nstloop))/Msun)
call runge(Ustar(2,nstloop),Ustar(3,nstloop),Ustar(1,nstloop),Ustar(5,nstloop),dt,nstloop,rsixc,rsjyc,rskzc,2,(Ustar(7,nstloop)+Ustar(19,nstloop))/Msun)
call runge(Ustar(3,nstloop),Ustar(1,nstloop),Ustar(2,nstloop),Ustar(6,nstloop),dt,nstloop,rsixc,rsjyc,rskzc,3,(Ustar(7,nstloop)+Ustar(19,nstloop))/Msun)
