...
program main
  ...
  integer l14,l15,l16,l17,l18,l19,l20,l21,l22,jump
...
!  goto 1000
  !open(150,file='Allnewbigtime098.DAT',FORM='UNFORMATTED')
  open(150,file=dir//'All/All098.DAT',access='stream',FORM='UNFORMATTED')
  do k=1,nz
     do j=1,ny
        do i=1,nx
           read(150) rho(i,j,k),aa,aa,aa,aa,aa,aa,aa,aa
           !write(*,*) rho(i,j,k)
        end do
     end do
...
!  do m=1,2
 ...
 !変換
  ...
  !open(110,file='taghighden.DAT',FORM='FORMATTED')
  open(110,file=dir//'tag/tag098001.DAT',FORM='UNFORMATTED')
  do k=1,nz,jump
     do j=1,ny,jump
        do i=1,nx,jump
