...
! do i1=1,itrchm
! dt=dt1
! call chem(Tmp1,ndpmd1,ndHmd1,ndH2md1,ndHmmd1,ndHemd1,ndHepmd1,ndCmd1,&
! ndCpmd1,ndCOmd1,ndemd1,ndtotmd1,Ntotmd1,NH2md1,NnCmd1,NCOmd1,tCIImd1,dt)
! enddo
! do i1=1,itrchm
! dt=dt1
! call chem(Tmp2,ndpmd2,ndHmd2,ndH2md2,ndHmmd2,ndHemd2,ndHepmd2,ndCmd2,&
! ndCpmd2,ndCOmd2,ndemd2,ndtotmd2,Ntotmd2,NH2md2,NnCmd2,NCOmd2,tCIImd2,dt)
! enddo

! do i1=1,itrchm
! dt=dt1
! call chem(Tmpmid,ndpl,ndHl,ndH2l,ndHml,ndHel,ndHepl,ndCl,&
! ndCpl,ndCOl,ndel,ndtotl,Ntotl,NH2l,NnCl,NCOl,tCIIl,dt)
! enddo
! do i1=1,itrchm
! dt=dt1
! call chem(Tmpmid,ndph,ndHh,ndH2h,ndHmh,ndHeh,ndHeph,ndCh,&
