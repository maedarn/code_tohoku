...
C     Borysow, Frommhold, and Moraldi (1989) ApJ,336,495
C     Equation (A11) (in K)
      implicit real*8(a-h,o-z)
c      
      Ev0=0.38496d0
...
C     xnH*xn(H2)*xLd_H2 : cooling rate owing to H2 per unit volume
      implicit real*8(a-h,o-z)
C     USES beta_esc, Q_bg
...
c
      ...
      A_21=1.1d-6
c
c     Hollenbach & McKee (1979) corrected with (1989)
...
c
      ...
      DT_21=ET(2,0)-ET(1,0)
c
c     Draine, Reberge, Dalgarno (1983)
...
c
c     H2-Hp collision : Gerlich(1990)
      xmeV=11.604d0
      if(j == 0) then 
c        2-0
...
c
c     H2-e collisional rate from Draine(1990)
         xj=dble(j)
