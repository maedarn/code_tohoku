...
wppre2(:,:,:)=wp2(:,:,:)
    ...
    do k=1,ndy-2
        do j=1,ndx-2
    wp2(j,k,1) = wp2(j,k,1)+cg*dt*wppre1(j,k,1)!*0.5d0
    wp2(j,k,2) = wp2(j,k,2)+cg*dt*wppre1(j,k,2)!*0.5d0
    wp2(j,k,3) = wp2(j,k,3)+cg*dt*wppre1(j,k,3)!*0.5d0
    wp2(j,k,4) = wp2(j,k,4)+cg*dt*wppre1(j,k,4)!*0.5d0
        enddo
    enddo
    endif
...
-0.5d0*dt*cg*(wppre2(j+1,k+1,1)-wppre2(j+1,k-1,1)-wppre2(j-1,k+1,1)+wppre2(j-1,k-1,1))/dx/dy
wp1(j,k,2) = wp1(j,k,2)-cg*G4pi*rho(j,k)*dt &
-0.5d0*dt*cg*(wppre2(j+1,k+1,2)-wppre2(j+1,k-1,2)-wppre2(j-1,k+1,2)+wppre2(j-1,k-1,2))/dx/dy
wp1(j,k,3) = wp1(j,k,3)-cg*G4pi*rho(j,k)*dt &
+0.5d0*dt*cg*(wppre2(j+1,k+1,3)-wppre2(j+1,k-1,3)-wppre2(j-1,k+1,3)+wppre2(j-1,k-1,3))/dx/dy
wp1(j,k,4) = wp1(j,k,4)-cg*G4pi*rho(j,k)*dt &
+0.5d0*dt*cg*(wppre2(j+1,k+1,4)-wppre2(j+1,k-1,4)-wppre2(j-1,k+1,4)+wppre2(j-1,k-1,4))/dx/dy
      enddo
    enddo
    endif
