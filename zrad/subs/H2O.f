...
c     100, 200, 400, 1000, 2000, 4000K
      real*8 :: xlTa(1:6)/2.000d0, 2.301d0, 2.602d0, 
     &     3.000d0, 3.301d0, 3.602d0/
      real*8 :: xlNa(1:10)/10.0d0, 11.0d0, 12.0d0, 13.0d0, 14.0d0, 
     &     15.0d0, 16.0d0, 17.0d0, 18.0d0, 19.0d0/  
      real*8 :: aL0a(1:6)/24.35d0, 23.87d0, 23.42d0, 
...
c     10, 20, 30, 50, 80, 100K
      real*8 :: xlTb(1:6)/1.000d0, 1.301d0, 1.477d0, 
     &     1.699d0, 1.903d0, 2.000d0/
      real*8 :: aL0bo(1:6)/26.81d0, 25.88d0, 25.43d0, 
...
c
      real*8 :: aL0bp(1:6)/27.01d0, 25.73d0, 25.24d0, 
