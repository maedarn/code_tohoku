...
c HD cooling from Galli and Palla (1998), A&A, 335, 403
c cooling is for T < 3000 K, in erg cm^3 s-1
      implicit real*8 (a-h,o-z)
      data xk_B/1.38066d-16/,h_Pl/6.62618d-27/,
     &     pi/3.14159265358979d0/,xm_p/1.67d-24/
c     USES Q_bg, beta_esc
c------------------------------------------------
c     Various parameters for HD
c-----------------------------------------------
c     
      g0=1.d0
      g1=3.d0
...
c
c     ---------------------------------------------------------------
c     Collisional transitions for HD, from Shaefer (1990) [HD,He]
c     with a corrective factor for [HD,H] from Wright & Morton (1979)
c     ---------------------------------------------------------------
...
c     
C---------------------------------------------------------------
C Computes cooling rate for HD
C---------------------------------------------------------------
