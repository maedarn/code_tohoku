...
character(33) :: dir='/work/maedarn/3DMHD/testcoollow4/'
END MODULE comvar
...
do in10 = 1, maxstp
  ...
  call SAVEUcheck(nunit,dt,stb,st,t,0)
...
call SAVEUcheck(nunit,dt,stb,st,t,1)

END SUBROUTINE EVOLVE

SUBROUTINE SAVEUcheck(nunit,dt,stb,st,t,msig)
USE comvar
USE mpivar
USE chmvar
USE slfgrv
...
open(11,FILE=dir//'xbcl'//filenm//NPENUM//'.dat',FORM='FORMATTED') !,CONVERT='LITTLE_ENDIAN')
open(12,FILE=dir//'xbcr'//filenm//NPENUM//'.dat',FORM='FORMATTED') !,CONVERT='LITTLE_ENDIAN')
!100 format(D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3)
  ...
  do j = 1, Ncelly+1
    write(11,*) (sngl(U(i,j,k,1)),sngl(U(i,j,k,2)),sngl(U(i,j,k,3)),sngl(U(i,j,k,4)),sngl(U(i,j,k,5)), &
               ...
               sngl(Phi(i,j,k)),i=-1,2 )

     write(12,*) (sngl(U(i,j,k,1)),sngl(U(i,j,k,2)),sngl(U(i,j,k,3)),sngl(U(i,j,k,4)),sngl(U(i,j,k,5)), &
               sngl(U(i,j,k,6)),sngl(U(i,j,k,7)),sngl(U(i,j,k,8)), &
               sngl(ndH(i,j,k)),sngl(ndp(i,j,k)),sngl(ndH2(i,j,k)),sngl(ndHe(i,j,k)), &
               sngl(ndHep(i,j,k)),sngl(ndC(i,j,k)),sngl(ndCO(i,j,k)),sngl(ndCp(i,j,k)), &
               sngl(Phi(i,j,k)),i=Ncellx-2,Ncellx+2 )
  end do
  end do
  close(11)
  close(12)

open(13,FILE=dir//'ybcl'//filenm//NPENUM//'.dat',FORM='FORMATTED') !,CONVERT='LITTLE_ENDIAN')
open(14,FILE=dir//'ybcr'//filenm//NPENUM//'.dat',FORM='FORMATTED') !,CONVERT='LITTLE_ENDIAN')
!100 format(D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3)
  k=1;j=1;i=1
  do i = 1, Ncellx+1
  do k = 1, Ncellz+1
    write(13,*) (sngl(U(i,j,k,1)),sngl(U(i,j,k,2)),sngl(U(i,j,k,3)),sngl(U(i,j,k,4)),sngl(U(i,j,k,5)), &
               sngl(U(i,j,k,6)),sngl(U(i,j,k,7)),sngl(U(i,j,k,8)), &
               sngl(ndH(i,j,k)),sngl(ndp(i,j,k)),sngl(ndH2(i,j,k)),sngl(ndHe(i,j,k)), &
               sngl(ndHep(i,j,k)),sngl(ndC(i,j,k)),sngl(ndCO(i,j,k)),sngl(ndCp(i,j,k)), &
               sngl(Phi(i,j,k)),j=-1,2 )

     write(14,*) (sngl(U(i,j,k,1)),sngl(U(i,j,k,2)),sngl(U(i,j,k,3)),sngl(U(i,j,k,4)),sngl(U(i,j,k,5)), &
               sngl(U(i,j,k,6)),sngl(U(i,j,k,7)),sngl(U(i,j,k,8)), &
               sngl(ndH(i,j,k)),sngl(ndp(i,j,k)),sngl(ndH2(i,j,k)),sngl(ndHe(i,j,k)), &
               sngl(ndHep(i,j,k)),sngl(ndC(i,j,k)),sngl(ndCO(i,j,k)),sngl(ndCp(i,j,k)), &
               sngl(Phi(i,j,k)),j=Ncelly-2,Ncelly+2 )
  end do
  end do
  close(13)
  close(14)

open(15,FILE=dir//'zbcl'//filenm//NPENUM//'.dat',FORM='FORMATTED') !,CONVERT='LITTLE_ENDIAN')
open(16,FILE=dir//'zbcr'//filenm//NPENUM//'.dat',FORM='FORMATTED') !,CONVERT='LITTLE_ENDIAN')
!100 format(D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3,D10.3)
  k=1;j=1;i=1
  do j = 1, Ncelly+1
  do i = 1, Ncellx+1
    write(15,*) (sngl(U(i,j,k,1)),sngl(U(i,j,k,2)),sngl(U(i,j,k,3)),sngl(U(i,j,k,4)),sngl(U(i,j,k,5)), &
               sngl(U(i,j,k,6)),sngl(U(i,j,k,7)),sngl(U(i,j,k,8)), &
               sngl(ndH(i,j,k)),sngl(ndp(i,j,k)),sngl(ndH2(i,j,k)),sngl(ndHe(i,j,k)), &
               sngl(ndHep(i,j,k)),sngl(ndC(i,j,k)),sngl(ndCO(i,j,k)),sngl(ndCp(i,j,k)), &
               sngl(Phi(i,j,k)),k=-1,2 )

     write(16,*) (sngl(U(i,j,k,1)),sngl(U(i,j,k,2)),sngl(U(i,j,k,3)),sngl(U(i,j,k,4)),sngl(U(i,j,k,5)), &
               sngl(U(i,j,k,6)),sngl(U(i,j,k,7)),sngl(U(i,j,k,8)), &
               sngl(ndH(i,j,k)),sngl(ndp(i,j,k)),sngl(ndH2(i,j,k)),sngl(ndHe(i,j,k)), &
               sngl(ndHep(i,j,k)),sngl(ndC(i,j,k)),sngl(ndCO(i,j,k)),sngl(ndCp(i,j,k)), &
               sngl(Phi(i,j,k)),k=Ncellz-2,Ncellz+2 )
  end do
  end do
  close(15)
  close(16)
end SUBROUTINE SAVEUcheck
